...
// des : listbox msg area
#define EVENT_LISTBOX_ITEM_DBLCLK           0x0701 // mouse left button double click
...
#define EVENT_LISTBOX_ITEM_DBRCLK			0x0704 // mouse right button double click
#define EVENT_LISTBOX_ITEM_RCLK				0X0705
