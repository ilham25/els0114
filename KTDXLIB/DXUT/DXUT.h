...
RECT                    DXUTGetFullscreenClientRectAtModeChange(); // Useful for returning to full screen mode with the same resolution as before toggle to windowed mode
void					DXUTSetWindowClientRectAtModeChange(int width, int height);
void					DXUTSetFullscreenClientRectAtModeChange(int width, int height);
double                  DXUTGetTime();
...
//////////////////////////////////////////////////////////////////////////
//## Desc : DXUT 용 윈도우 생성 함수를 사용하지 않고 호출되어야할 함수들..
HRESULT		DXUTNoCreateWindow(HWND hClienthWnd);
//////////////////////////////////////////////////////////////////////////

//{{ JHKang / 강정훈 / 2010.9.2 / 백 버퍼 재설정
