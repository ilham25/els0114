...
public:
	...
	HRESULT Create( CSound** ppSound, BYTE* pbData, ULONG ulDataSize, DWORD dwCreationFlags = 0, GUID guid3DAlgorithm = GUID_NULL, DWORD dwNumBuffers = 1 );
...
public:
	...
	HRESULT Open( BYTE* data, ULONG size, WAVEFORMATEX* pwfx, DWORD dwFlags );
