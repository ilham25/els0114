...
//{{ robobeg : 2008-10-14
    ...
    assert( m_pManager->GetD3DDevice() && L"To fix hook up CDXUTDialogResourceManager to device callbacks.  See comments for details" );
//}} robobeg : 2008-10-14
...
//{{ robobeg : 2008-10-14
    ...
    static const CKTDGStateManager::KState akStates[] = 
    {
        ...
        KRenderState( D3DRS_SEPARATEALPHABLENDENABLE, FALSE ),
        KRenderState( D3DRS_BLENDOP, D3DBLENDOP_ADD ),
        KRenderState( D3DRS_COLORWRITEENABLE, D3DCOLORWRITEENABLE_ALPHA|D3DCOLORWRITEENABLE_BLUE|D3DCOLORWRITEENABLE_GREEN|D3DCOLORWRITEENABLE_RED ),
        KRenderState( D3DRS_SHADEMODE, D3DSHADE_GOURAUD ),
        KRenderState( D3DRS_FOGENABLE, FALSE ),
        KRenderState( D3DRS_ZWRITEENABLE, FALSE ),
        KRenderState( D3DRS_FILLMODE, D3DFILL_SOLID ),
        ...
        KTextureStageState( 0, D3DTSS_RESULTARG, D3DTA_CURRENT ),
        KTextureStageState( 1, D3DTSS_COLOROP, D3DTOP_DISABLE ),
        KTextureStageState( 1, D3DTSS_ALPHAOP, D3DTOP_DISABLE ),
    };//akStates[]
    ...
    KD3DPUSH( akStates )
        ...
        CKTDGStateManager::SetTextureStageState( 0, D3DTSS_COLORARG2, D3DTA_DIFFUSE );
        
        CKTDGStateManager::SetTextureStageState( 0, D3DTSS_ALPHAOP, D3DTOP_MODULATE );
        CKTDGStateManager::SetTextureStageState( 0, D3DTSS_ALPHAARG1, D3DTA_TEXTURE );
...
//{{ robobeg : 2008-10-22
        ...
        CKTDGStateManager::SetTexture( 0, pTextureNode->pTexture );
//}} robobeg : 2008-10-22

//      m_pManager->m_pSprite->Begin( D3DXSPRITE_DONOTSAVESTATE );
        m_pManager->m_pSprite->Begin( 0 );
...
void CDXUTDialog::InitDefaultElementsHelper()
{
    ...
    Element.SetTexture( 0, &rcTexture );
	Element.TextureColor.States[ DXUT_STATE_NORMAL ] = D3DCOLOR_ARGB(100, 255, 255, 255);
...
bool CDXUTListBox::HandleMouse( UINT uMsg, POINT pt, WPARAM wParam, LPARAM lParam )
{
    ...
    switch( uMsg )
    {
		...
		case WM_RBUTTONDBLCLK:
			{
				m_pDialog->SendEvent( EVENT_LISTBOX_ITEM_DBRCLK, true, this );
				return true;
			}
			break;
		case WM_RBUTTONDOWN:
			{
				m_pDialog->SendEvent( EVENT_LISTBOX_ITEM_RCLK, true, this );
				return true;
			}
			break;
...
void CDXUTEditBox::ParseFloatArray( float *pNumbers, int nCount )
{
    ...
    while( nWritten < nCount && *pToken != L'\0' )
    {
        ...
        StringCchCopy( wszToken, nTokenLen+1, pToken );
