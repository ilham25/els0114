...
public:
...
#ifdef KEYFRAME_CAMERA
	virtual void SetViewParams( D3DXVECTOR3* pvEyePt, D3DXVECTOR3* pvLookatPt, D3DXVECTOR3* pvUpVec);
#endif KEYFRAME_CAMERA
	...
	void ClearKeys(){m_cKeysDown = 0; ZeroMemory( m_aKeys, sizeof(BYTE)*CAM_MAX_KEYS ); }
