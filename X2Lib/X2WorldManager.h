...
{	
    public:
        ...
        DECLARE_HELP_SYSTEM( CX2WorldManager );
	...
	public:
		CX2WorldManager();
		virtual ~CX2WorldManager(void);

#ifdef X2TOOL
		CX2World* CreateWorld( wstring wstrWorldName, KLuabinder* pKLuabinder = NULL );
#endif
		CX2World* CreateWorld( const CX2World::WORLD_ID worldID, KLuabinder* pKLuabinder = NULL, const bool bBackgroundLoad_ = false );
	...
	public: 
		const vector<CX2World::WorldData*>& GetWorldDataList() { return m_WorldDataList; }
...
// #endif // BACKGROUND_LOADING_TEST // 2008-10-18
	...
	//}}	
		...
		vector<CX2World::WorldData*>	m_WorldDataList;		
