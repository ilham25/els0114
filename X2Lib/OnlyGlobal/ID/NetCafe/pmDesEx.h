// pmDesEx.h: interface for the CpmDesEx class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_PMDESEX_H__F2FCB29C_91B2_4B87_BE7B_174C68CA383A__INCLUDED_)
#define AFX_PMDESEX_H__F2FCB29C_91B2_4B87_BE7B_174C68CA383A__INCLUDED_
...
//====================================================================================================
// CpmDesEx: AES Crypt API Base Class
//====================================================================================================
class CpmDesEx
{
public:
...
//====================================================================================================
// CAESCryptAPI: AES Crypt API Lapper Class
//====================================================================================================
class CAESCryptAPI : public CpmDesEx
{
protected:
// Attributes
...
public:
	char* deletePadding(const char *pszSource);
	char* addPadding(const char *pszSource);

	CAESCryptAPI(
			LPCTSTR pszPrivateKey, 
			LPCTSTR pszPublicKey, 
			long nUsePadding = 0, 
			int nKeyLength = DEFAULT_BLOCK_SIZE, 
			int nBlockSize = DEFAULT_BLOCK_SIZE);

	virtual ~CAESCryptAPI();

	void EncryptAPI(const char* pszSourcee);
	void DecryptAPI(const char* pszDecrypt);

	const char* GetCryptString();
};


#endif // !defined(AFX_PMDESEX_H__F2FCB29C_91B2_4B87_BE7B_174C68CA383A__INCLUDED_)
