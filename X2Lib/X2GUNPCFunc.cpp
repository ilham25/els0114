...
void CX2GUNPCFunc::SetNPC( CX2GUNPC* pNPC )
{
	...
	if( pNPC == NULL || pNPC->GetNPCTemplet() == NULL )
		return;
    ...
    case CX2UnitManager::NUI_BEE_JUMP:
		{
			SET_START_FUNC(			npcID, L"BEE_FLY",						CX2GUNPCFunc, BEE_FLY_STATE_START );
			SET_FRAME_MOVE_FUNC(	npcID, L"BEE_FLY",						CX2GUNPCFunc, BEE_FLY_FRAME_MOVE );
			SET_END_FUNC(			npcID, L"BEE_JUMP_DOWN",				CX2GUNPCFunc, BEE_JUMP_DOWN_STATE_END );
			SET_END_FUNC(			npcID, L"BEE_JUMP_DOWN_DIR",			CX2GUNPCFunc, BEE_JUMP_DOWN_DIR_STATE_END );
			SET_FRAME_MOVE_FUNC(	npcID, L"BEE_DAMAGE",				    CX2GUNPCFunc, BEE_DAMAGE_SMALL_FRAME_MOVE );
			SET_FRAME_MOVE_FUNC(	npcID, L"BEE_DAMAGE_DOWN",				CX2GUNPCFunc, BEE_DAMAGE_DOWN_FRAME_MOVE );
			SET_FRAME_MOVE_FUNC(	npcID, L"BEE_DAMAGE_AIR_DOWN_LANDING",	CX2GUNPCFunc, BEE_DAMAGE_AIR_DOWN_LANDING_FRAME_MOVE );
			SET_START_FUNC(			npcID, L"BEE_DYING_LAND",				CX2GUNPCFunc, BEE_DYING_LAND_STATE_START );
		}
		break;
    
    case CX2UnitManager::NUI_BEE_NODROP:
        {
            SET_END_FUNC(           npcID, L"BEE_JUMP_DOWN",         CX2GUNPCFunc, BEE_NODROP_JUMP_DOWN_STATE_END );
            SET_END_FUNC(           npcID, L"BEE_JUMP_DOWN_DIR",     CX2GUNPCFunc, BEE_NODROP_JUMP_DOWN_DIR_STATE_END );
            SET_FRAME_MOVE_FUNC(    npcID, L"BEE_DAMAGE",            CX2GUNPCFunc, BEE_NODROP_DAMAGE_SMALL_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"BEE_DAMAGE_DOWN",       CX2GUNPCFunc, BEE_NODROP_DAMAGE_DOWN_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"BEE_DAMAGE_AIR_DOWN_LANDING", CX2GUNPCFunc, BEE_NODROP_DAMAGE_AIR_DOWN_LANDING_FRAME_MOVE );
            SET_START_FUNC(         npcID, L"BEE_DYING_LAND",        CX2GUNPCFunc, BEE_NODROP_DYING_LAND_STATE_START );
            SET_START_FUNC(         npcID, L"BEE_DYING_SKY",         CX2GUNPCFunc, BEE_NODROP_DYING_LAND_STATE_START );
        }
        break;

    case CX2UnitManager::NUI_BEEBOMB:
        {
            SET_END_FUNC(           npcID, L"BEE_BOMB_JUMP_DOWN",           CX2GUNPCFunc, BEE_BOMB_JUMP_DOWN_STATE_END );
            SET_END_FUNC(           npcID, L"BEE_BOMB_JUMP_DOWN_DIR",       CX2GUNPCFunc, BEE_BOMB_JUMP_DOWN_DIR_STATE_END );
            SET_FRAME_MOVE_FUNC(    npcID, L"BEE_BOMB_ANGRY",               CX2GUNPCFunc, BEE_BOMB_ANGRY_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"BEE_BOMB_BOMB_ATTACK",         CX2GUNPCFunc, BEE_BOMB_BOMB_ATTACK_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"BEE_BOMB_DAMAGE",              CX2GUNPCFunc, BEE_BOMB_DAMAGE_SMALL_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"BEE_BOMB_DAMAGE_DOWN",         CX2GUNPCFunc, BEE_BOMB_DAMAGE_DOWN_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"BEE_BOMB_DAMAGE_AIR_DOWN_LANDING", CX2GUNPCFunc, BEE_BOMB_DAMAGE_AIR_DOWN_LANDING_FRAME_MOVE );
            SET_START_FUNC(         npcID, L"BEE_BOMB_BOMB_EXPLODE",        CX2GUNPCFunc, BEE_BOMB_BOMB_EXPLODE_STATE_START );
            SET_START_FUNC(         npcID, L"BEE_BOMB_DYING_LAND",          CX2GUNPCFunc, BEE_BOMB_DYING_LAND_STATE_START );
            SET_START_FUNC(         npcID, L"BEE_BOMB_DYING_SKY",           CX2GUNPCFunc, BEE_BOMB_DYING_LAND_STATE_START );
        }
        break;

    case CX2UnitManager::NUI_BEEBOMB_NODROP:
        {
            SET_END_FUNC(           npcID, L"BEE_JUMP_DOWN",        CX2GUNPCFunc, BEE_BOMB_NODROP_JUMP_DOWN_STATE_END );
            SET_END_FUNC(           npcID, L"BEE_JUMP_DOWN_DIR",    CX2GUNPCFunc, BEE_BOMB_NODROP_JUMP_DOWN_DIR_STATE_END );
            SET_FRAME_MOVE_FUNC(    npcID, L"BEE_ANGRY",            CX2GUNPCFunc, BEE_BOMB_NODROP_ANGRY_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"BEE_BOMB_ATTACK",      CX2GUNPCFunc, BEE_BOMB_NODROP_BOMB_ATTACK_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"BEE_DAMAGE",           CX2GUNPCFunc, BEE_BOMB_NODROP_DAMAGE_SMALL_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"BEE_DAMAGE_DOWN",      CX2GUNPCFunc, BEE_BOMB_NODROP_DAMAGE_DOWN_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"BEE_DAMAGE_AIR_DOWN_LANDING", CX2GUNPCFunc, BEE_BOMB_NODROP_DAMAGE_AIR_DOWN_LANDING_FRAME_MOVE );
            SET_START_FUNC(         npcID, L"BEE_BOMB_EXPLODE",     CX2GUNPCFunc, BEE_BOMB_NODROP_BOMB_EXPLODE_STATE_START );
            SET_START_FUNC(         npcID, L"BEE_DYING_LAND",       CX2GUNPCFunc, BEE_BOMB_NODROP_DYING_LAND_STATE_START );
            SET_START_FUNC(         npcID, L"BEE_DYING_SKY",        CX2GUNPCFunc, BEE_BOMB_NODROP_DYING_LAND_STATE_START );
        }
        break;

    case CX2UnitManager::NUI_BEEPOISON:
        {
            SET_END_FUNC(           npcID, L"BEE_POISON_JUMP_DOWN",             CX2GUNPCFunc, BEE_POISON_JUMP_DOWN_STATE_END );
            SET_END_FUNC(           npcID, L"BEE_POISON_JUMP_DOWN_DIR",         CX2GUNPCFunc, BEE_POISON_JUMP_DOWN_DIR_STATE_END );
            SET_FRAME_MOVE_FUNC(    npcID, L"BEE_POISON_DAMAGE",                CX2GUNPCFunc, BEE_POISON_DAMAGE_SMALL_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"BEE_POISON_DAMAGE_DOWN",           CX2GUNPCFunc, BEE_POISON_DAMAGE_DOWN_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"BEE_POISON_DAMAGE_AIR_DOWN_LANDING", CX2GUNPCFunc, BEE_POISON_DAMAGE_AIR_DOWN_LANDING_FRAME_MOVE );
            SET_START_FUNC(         npcID, L"BEE_POISON_DYING_LAND",            CX2GUNPCFunc, BEE_POISON_DYING_LAND_STATE_START );
            SET_START_FUNC(         npcID, L"BEE_POISON_DYING_SKY",             CX2GUNPCFunc, BEE_POISON_DYING_LAND_STATE_START );
        }
        break;
    ...
    case CX2UnitManager::NUI_BEE_ASSAULT:
        {
            SET_END_FUNC(           npcID, L"BEE_ASSAULT_JUMP_DOWN",            CX2GUNPCFunc, BEE_ASSAULT_JUMP_DOWN_STATE_END );
            SET_END_FUNC(           npcID, L"BEE_ASSAULT_JUMP_DOWN_DIR",        CX2GUNPCFunc, BEE_ASSAULT_JUMP_DOWN_DIR_STATE_END );
            SET_FRAME_MOVE_FUNC(    npcID, L"BEE_ASSAULT_BOMB_ATTACK",          CX2GUNPCFunc, BEE_ASSAULT_BOMB_ATTACK_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"BEE_ASSAULT_DAMAGE",               CX2GUNPCFunc, BEE_ASSAULT_DAMAGE_SMALL_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"BEE_ASSAULT_DAMAGE_DOWN",          CX2GUNPCFunc, BEE_ASSAULT_DAMAGE_DOWN_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"BEE_ASSAULT_DAMAGE_AIR_DOWN_LANDING", CX2GUNPCFunc, BEE_ASSAULT_DAMAGE_AIR_DOWN_LANDING_FRAME_MOVE );
            SET_START_FUNC(         npcID, L"BEE_ASSAULT_DYING_LAND",           CX2GUNPCFunc, BEE_ASSAULT_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"BEE_ASSAULT_DYING_SKY",            CX2GUNPCFunc, BEE_ASSAULT_DYING_LAND_STATE_START);
        }
        break;

    case CX2UnitManager::NUI_BEEHOUSE:
        {
            SET_START_FUNC(         npcID, L"BEE_HOUSE_START",                  CX2GUNPCFunc, BEE_HOUSE_START_STATE_START );
            SET_FRAME_MOVE_FUNC(    npcID, L"BEE_HOUSE_RESPAWN",                CX2GUNPCFunc, BEE_HOUSE_RESPAWN_FRAME_MOVE );
            SET_START_FUNC(         npcID, L"BEE_HOUSE_DYING",                  CX2GUNPCFunc, BEE_HOUSE_DYING_STATE_START );
        }
        break;

    case CX2UnitManager::NUI_BEEBOMBHOUSE:
        {
            SET_START_FUNC(         npcID, L"BEE_BOMB_HOUSE_START",             CX2GUNPCFunc, BEE_BOMB_HOUSE_START_STATE_START );
            SET_FRAME_MOVE_FUNC(    npcID, L"BEE_BOMB_HOUSE_RESPAWN",           CX2GUNPCFunc, BEE_BOMB_HOUSE_RESPAWN_FRAME_MOVE );
            SET_START_FUNC(         npcID, L"BEE_BOMB_HOUSE_DYING",             CX2GUNPCFunc, BEE_BOMB_HOUSE_DYING_STATE_START );
        }
        break;

    case CX2UnitManager::NUI_BEEPOISONHOUSE:
        {
            SET_START_FUNC(         npcID, L"BEE_POISON_HOUSE_START",           CX2GUNPCFunc, BEE_POISON_HOUSE_START_STATE_START );
            SET_FRAME_MOVE_FUNC(    npcID, L"BEE_POISON_HOUSE_RESPAWN",         CX2GUNPCFunc, BEE_POISON_HOUSE_RESPAWN_FRAME_MOVE );
            SET_START_FUNC(         npcID, L"BEE_POISON_HOUSE_DYING",           CX2GUNPCFunc, BEE_POISON_HOUSE_DYING_STATE_START );
        }
        break;
    
    case CX2UnitManager::NUI_MONKEY_A:
        {
            SET_FRAME_MOVE_FUNC(	npcID, L"MONKEY_A_WAIT2",				CX2GUNPCFunc, MONKEY_A_WAIT2_FRAME_MOVE );
            SET_END_FUNC(			npcID, L"MONKEY_A_WALK",				CX2GUNPCFunc, MONKEY_A_WALK_STATE_END );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_A_WAIT3",               CX2GUNPCFunc, MONKEY_A_WAIT3_FRAME_MOVE );
            SET_END_FUNC(           npcID, L"MONKEY_A_JUMP_DOWN",           CX2GUNPCFunc, MONKEY_A_JUMP_DOWN_STATE_END );
            SET_END_FUNC(           npcID, L"MONKEY_A_JUMP_DOWN_DIR",       CX2GUNPCFunc, MONKEY_A_JUMP_DOWN_DIR_STATE_END );

			SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_A_FLY_READY",			CX2GUNPCFunc, MONKEY_A_FLY_READY_FRAME_MOVE );
			

			SET_START_FUNC(         npcID, L"MONKEY_A_FLY",					CX2GUNPCFunc, MONKEY_A_FLY_STATE_START);
			SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_A_FLY",					CX2GUNPCFunc, MONKEY_A_FLY_FRAME_MOVE);
			

            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_A_DAMAGE_SMALL",        CX2GUNPCFunc, MONKEY_A_DAMAGE_SMALL_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_A_DAMAGE_BIG",          CX2GUNPCFunc, MONKEY_A_DAMAGE_BIG_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_A_DAMAGE_DOWN_FRONT",   CX2GUNPCFunc, MONKEY_A_DAMAGE_DOWN_FRONT_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_A_DAMAGE_DOWN_BACK",    CX2GUNPCFunc, MONKEY_A_DAMAGE_DOWN_BACK_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_A_DAMAGE_AIR_DOWN_LANDING", CX2GUNPCFunc, MONKEY_A_DAMAGE_AIR_DOWN_LANDING_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_A_STAND_UP_ATTACK_FRONT",   CX2GUNPCFunc, MONKEY_A_STAND_UP_ATTACK_FRONT_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_A_STAND_UP_ATTACK_BACK",    CX2GUNPCFunc, MONKEY_A_STAND_UP_ATTACK_BACK_FRAME_MOVE );
            SET_START_FUNC(         npcID, L"MONKEY_A_DYING_LAND_FRONT",    CX2GUNPCFunc, MONKEY_A_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"MONKEY_A_DYING_LAND_BACK",     CX2GUNPCFunc, MONKEY_A_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"MONKEY_A_DYING_SKY",           CX2GUNPCFunc, MONKEY_A_DYING_LAND_STATE_START);
        }
        break;

    case CX2UnitManager::NUI_MONKEY_A_NODROP:
        {
            SET_FRAME_MOVE_FUNC(	npcID, L"MONKEY_A_WAIT2",				CX2GUNPCFunc, MONKEY_A_NODROP_WAIT2_FRAME_MOVE );
            SET_END_FUNC(			npcID, L"MONKEY_A_WALK",				CX2GUNPCFunc, MONKEY_A_NODROP_WALK_STATE_END );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_A_WAIT3",               CX2GUNPCFunc, MONKEY_A_NODROP_WAIT3_FRAME_MOVE );
            SET_END_FUNC(           npcID, L"MONKEY_A_JUMP_DOWN",           CX2GUNPCFunc, MONKEY_A_NODROP_JUMP_DOWN_STATE_END );
            SET_END_FUNC(           npcID, L"MONKEY_A_JUMP_DOWN_DIR",       CX2GUNPCFunc, MONKEY_A_NODROP_JUMP_DOWN_DIR_STATE_END );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_A_DAMAGE_SMALL",        CX2GUNPCFunc, MONKEY_A_NODROP_DAMAGE_SMALL_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_A_DAMAGE_BIG",          CX2GUNPCFunc, MONKEY_A_NODROP_DAMAGE_BIG_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_A_DAMAGE_DOWN_FRONT",   CX2GUNPCFunc, MONKEY_A_NODROP_DAMAGE_DOWN_FRONT_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_A_DAMAGE_DOWN_BACK",    CX2GUNPCFunc, MONKEY_A_NODROP_DAMAGE_DOWN_BACK_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_A_DAMAGE_AIR_DOWN_LANDING", CX2GUNPCFunc, MONKEY_A_NODROP_DAMAGE_AIR_DOWN_LANDING_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_A_STAND_UP_ATTACK_FRONT",   CX2GUNPCFunc, MONKEY_A_NODROP_STAND_UP_ATTACK_FRONT_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_A_STAND_UP_ATTACK_BACK",    CX2GUNPCFunc, MONKEY_A_NODROP_STAND_UP_ATTACK_BACK_FRAME_MOVE );
            SET_START_FUNC(         npcID, L"MONKEY_A_DYING_LAND_FRONT",    CX2GUNPCFunc, MONKEY_A_NODROP_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"MONKEY_A_DYING_LAND_BACK",     CX2GUNPCFunc, MONKEY_A_NODROP_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"MONKEY_A_DYING_SKY",           CX2GUNPCFunc, MONKEY_A_NODROP_DYING_LAND_STATE_START);
        }
        break;

    case CX2UnitManager::NUI_MONKEY_B:
        {
            SET_FRAME_MOVE_FUNC(	npcID, L"MONKEY_B_WAIT2",				CX2GUNPCFunc, MONKEY_B_WAIT2_FRAME_MOVE );
            SET_END_FUNC(			npcID, L"MONKEY_B_WALK",				CX2GUNPCFunc, MONKEY_B_WALK_STATE_END );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_B_WAIT3",               CX2GUNPCFunc, MONKEY_B_WAIT3_FRAME_MOVE );
            SET_END_FUNC(           npcID, L"MONKEY_B_JUMP_DOWN",           CX2GUNPCFunc, MONKEY_B_JUMP_DOWN_STATE_END );
            SET_END_FUNC(           npcID, L"MONKEY_B_JUMP_DOWN_DIR",       CX2GUNPCFunc, MONKEY_B_JUMP_DOWN_DIR_STATE_END );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_B_PUNCH_PUNCH_ATTACK",  CX2GUNPCFunc, MONKEY_B_PUNCH_PUNCH_ATTACK_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_B_DAMAGE_SMALL",        CX2GUNPCFunc, MONKEY_B_DAMAGE_SMALL_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_B_DAMAGE_BIG",          CX2GUNPCFunc, MONKEY_B_DAMAGE_BIG_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_B_DAMAGE_DOWN_FRONT",   CX2GUNPCFunc, MONKEY_B_DAMAGE_DOWN_FRONT_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_B_DAMAGE_DOWN_BACK",    CX2GUNPCFunc, MONKEY_B_DAMAGE_DOWN_BACK_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_B_DAMAGE_AIR_DOWN_LANDING", CX2GUNPCFunc, MONKEY_B_DAMAGE_AIR_DOWN_LANDING_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_B_STAND_UP_ATTACK_FRONT",   CX2GUNPCFunc, MONKEY_B_STAND_UP_ATTACK_FRONT_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_B_STAND_UP_ATTACK_BACK",    CX2GUNPCFunc, MONKEY_B_STAND_UP_ATTACK_BACK_FRAME_MOVE );
            SET_START_FUNC(         npcID, L"MONKEY_B_DYING_LAND_FRONT",    CX2GUNPCFunc, MONKEY_B_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"MONKEY_B_DYING_LAND_BACK",     CX2GUNPCFunc, MONKEY_B_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"MONKEY_B_DYING_SKY",           CX2GUNPCFunc, MONKEY_B_DYING_LAND_STATE_START);
        }
        break;

    case CX2UnitManager::NUI_MONKEY_B_NODROP:
        {
            SET_FRAME_MOVE_FUNC(	npcID, L"MONKEY_B_WAIT2",				CX2GUNPCFunc, MONKEY_B_NODROP_WAIT2_FRAME_MOVE );
            SET_END_FUNC(			npcID, L"MONKEY_B_WALK",				CX2GUNPCFunc, MONKEY_B_NODROP_WALK_STATE_END );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_B_WAIT3",               CX2GUNPCFunc, MONKEY_B_NODROP_WAIT3_FRAME_MOVE );
            SET_END_FUNC(           npcID, L"MONKEY_B_JUMP_DOWN",           CX2GUNPCFunc, MONKEY_B_NODROP_JUMP_DOWN_STATE_END );
            SET_END_FUNC(           npcID, L"MONKEY_B_JUMP_DOWN_DIR",       CX2GUNPCFunc, MONKEY_B_NODROP_JUMP_DOWN_DIR_STATE_END );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_B_PUNCH_PUNCH_ATTACK",  CX2GUNPCFunc, MONKEY_B_PUNCH_PUNCH_ATTACK_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_B_DAMAGE_SMALL",        CX2GUNPCFunc, MONKEY_B_NODROP_DAMAGE_SMALL_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_B_DAMAGE_BIG",          CX2GUNPCFunc, MONKEY_B_NODROP_DAMAGE_BIG_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_B_DAMAGE_DOWN_FRONT",   CX2GUNPCFunc, MONKEY_B_NODROP_DAMAGE_DOWN_FRONT_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_B_DAMAGE_DOWN_BACK",    CX2GUNPCFunc, MONKEY_B_NODROP_DAMAGE_DOWN_BACK_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_B_DAMAGE_AIR_DOWN_LANDING", CX2GUNPCFunc, MONKEY_B_NODROP_DAMAGE_AIR_DOWN_LANDING_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_B_STAND_UP_ATTACK_FRONT",   CX2GUNPCFunc, MONKEY_B_NODROP_STAND_UP_ATTACK_FRONT_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_B_STAND_UP_ATTACK_BACK",    CX2GUNPCFunc, MONKEY_B_NODROP_STAND_UP_ATTACK_BACK_FRAME_MOVE );
            SET_START_FUNC(         npcID, L"MONKEY_B_DYING_LAND_FRONT",    CX2GUNPCFunc, MONKEY_B_NODROP_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"MONKEY_B_DYING_LAND_BACK",     CX2GUNPCFunc, MONKEY_B_NODROP_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"MONKEY_B_DYING_SKY",           CX2GUNPCFunc, MONKEY_B_NODROP_DYING_LAND_STATE_START);
        }
        break;

    case CX2UnitManager::NUI_MONKEY_APPLE:
        {
            SET_FRAME_MOVE_FUNC(	npcID, L"MONKEY_APPLE_WAIT2",				CX2GUNPCFunc, MONKEY_APPLE_WAIT2_FRAME_MOVE );
            SET_END_FUNC(			npcID, L"MONKEY_APPLE_WALK",				CX2GUNPCFunc, MONKEY_APPLE_WALK_STATE_END );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_APPLE_WAIT3",               CX2GUNPCFunc, MONKEY_APPLE_WAIT3_FRAME_MOVE );
            SET_END_FUNC(           npcID, L"MONKEY_APPLE_JUMP_DOWN",           CX2GUNPCFunc, MONKEY_APPLE_JUMP_DOWN_STATE_END );
            SET_END_FUNC(           npcID, L"MONKEY_APPLE_JUMP_DOWN_DIR",       CX2GUNPCFunc, MONKEY_APPLE_JUMP_DOWN_DIR_STATE_END );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_APPLE_APPLE_ATTACK",        CX2GUNPCFunc, MONKEY_APPLE_APPLE_ATTACK_FRAME_MOVE );

			SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_APPLE_WAIT",				CX2GUNPCFunc, MONKEY_APPLE_WAIT_FRAME_MOVE );
			SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_APPLE_WALK",				CX2GUNPCFunc, MONKEY_APPLE_WALK_FRAME_MOVE );
			SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_APPLE_RIDE_HORSE",			CX2GUNPCFunc, MONKEY_APPLE_RIDE_HORSE_STATE_START );
			SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_APPLE_RIDE_HORSE",			CX2GUNPCFunc, MONKEY_APPLE_RIDE_HORSE_FRAME_MOVE );
			SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_APPLE_RIDE_APPLE_ATTACK",   CX2GUNPCFunc, MONKEY_APPLE_RIDE_APPLE_ATTACK_FRAME_MOVE );
			SET_END_FUNC(			npcID, L"MONKEY_APPLE_LEAVE_HORSE",			CX2GUNPCFunc, MONKEY_APPLE_LEAVE_HORSE_STATE_END );

            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_APPLE_DAMAGE_SMALL",        CX2GUNPCFunc, MONKEY_APPLE_DAMAGE_SMALL_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_APPLE_DAMAGE_BIG",          CX2GUNPCFunc, MONKEY_APPLE_DAMAGE_BIG_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_APPLE_DAMAGE_DOWN_FRONT",   CX2GUNPCFunc, MONKEY_APPLE_DAMAGE_DOWN_FRONT_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_APPLE_DAMAGE_DOWN_BACK",    CX2GUNPCFunc, MONKEY_APPLE_DAMAGE_DOWN_BACK_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_APPLE_DAMAGE_AIR_DOWN_LANDING", CX2GUNPCFunc, MONKEY_APPLE_DAMAGE_AIR_DOWN_LANDING_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_APPLE_STAND_UP_ATTACK_FRONT",   CX2GUNPCFunc, MONKEY_APPLE_STAND_UP_ATTACK_FRONT_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_APPLE_STAND_UP_ATTACK_BACK",    CX2GUNPCFunc, MONKEY_APPLE_STAND_UP_ATTACK_BACK_FRAME_MOVE );
            SET_START_FUNC(         npcID, L"MONKEY_APPLE_DYING_LAND_FRONT",    CX2GUNPCFunc, MONKEY_APPLE_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"MONKEY_APPLE_DYING_LAND_BACK",     CX2GUNPCFunc, MONKEY_APPLE_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"MONKEY_APPLE_DYING_SKY",           CX2GUNPCFunc, MONKEY_APPLE_DYING_LAND_STATE_START);
        }
        break;

    case CX2UnitManager::NUI_MONKEY_APPLE_NODROP:
        {
            SET_FRAME_MOVE_FUNC(	npcID, L"MONKEY_APPLE_WAIT2",				CX2GUNPCFunc, MONKEY_APPLE_NODROP_WAIT2_FRAME_MOVE );
            SET_END_FUNC(			npcID, L"MONKEY_APPLE_WALK",				CX2GUNPCFunc, MONKEY_APPLE_NODROP_WALK_STATE_END );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_APPLE_WAIT3",               CX2GUNPCFunc, MONKEY_APPLE_NODROP_WAIT3_FRAME_MOVE );
            SET_END_FUNC(           npcID, L"MONKEY_APPLE_JUMP_DOWN",           CX2GUNPCFunc, MONKEY_APPLE_NODROP_JUMP_DOWN_STATE_END );
            SET_END_FUNC(           npcID, L"MONKEY_APPLE_JUMP_DOWN_DIR",       CX2GUNPCFunc, MONKEY_APPLE_NODROP_JUMP_DOWN_DIR_STATE_END );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_APPLE_APPLE_ATTACK",        CX2GUNPCFunc, MONKEY_APPLE_NODROP_APPLE_ATTACK_FRAME_MOVE );
            ...
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_APPLE_DAMAGE_SMALL",        CX2GUNPCFunc, MONKEY_APPLE_NODROP_DAMAGE_SMALL_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_APPLE_DAMAGE_BIG",          CX2GUNPCFunc, MONKEY_APPLE_NODROP_DAMAGE_BIG_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_APPLE_DAMAGE_DOWN_FRONT",   CX2GUNPCFunc, MONKEY_APPLE_NODROP_DAMAGE_DOWN_FRONT_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_APPLE_DAMAGE_DOWN_BACK",    CX2GUNPCFunc, MONKEY_APPLE_NODROP_DAMAGE_DOWN_BACK_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_APPLE_DAMAGE_AIR_DOWN_LANDING", CX2GUNPCFunc, MONKEY_APPLE_NODROP_DAMAGE_AIR_DOWN_LANDING_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_APPLE_STAND_UP_ATTACK_FRONT",   CX2GUNPCFunc, MONKEY_APPLE_NODROP_STAND_UP_ATTACK_FRONT_FRAME_MOVE );
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_APPLE_STAND_UP_ATTACK_BACK",    CX2GUNPCFunc, MONKEY_APPLE_NODROP_STAND_UP_ATTACK_BACK_FRAME_MOVE );
            SET_START_FUNC(         npcID, L"MONKEY_APPLE_DYING_LAND_FRONT",    CX2GUNPCFunc, MONKEY_APPLE_NODROP_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"MONKEY_APPLE_DYING_LAND_BACK",     CX2GUNPCFunc, MONKEY_APPLE_NODROP_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"MONKEY_APPLE_DYING_SKY",           CX2GUNPCFunc, MONKEY_APPLE_NODROP_DYING_LAND_STATE_START);
        }
        break;

    case CX2UnitManager::NUI_MONKEY_BOMB:
        {
            SET_START_FUNC(         npcID, L"MONKEY_BOMB_SIEGE_WAIT",           CX2GUNPCFunc, MONKEY_BOMB_SIEGE_WAIT_STATE_START);
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_BOMB_SIEGE_BOMB_ATTACK",    CX2GUNPCFunc, MONKEY_BOMB_SIEGE_BOMB_ATTACK_FRAME_MOVE);
            SET_START_FUNC(         npcID, L"MONKEY_BOMB_WAIT",                 CX2GUNPCFunc, MONKEY_BOMB_WAIT_STATE_START);
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_BOMB_WAIT2",                CX2GUNPCFunc, MONKEY_BOMB_WAIT2_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_BOMB_WAIT3",                CX2GUNPCFunc, MONKEY_BOMB_WAIT3_FRAME_MOVE);
            SET_END_FUNC(           npcID, L"MONKEY_BOMB_WALK",                 CX2GUNPCFunc, MONKEY_BOMB_WALK_STATE_END);
            SET_END_FUNC(           npcID, L"MONKEY_BOMB_JUMP_DOWN",            CX2GUNPCFunc, MONKEY_BOMB_JUMP_DOWN_STATE_END);
            SET_END_FUNC(           npcID, L"MONKEY_BOMB_JUMP_DOWN_DIR",        CX2GUNPCFunc, MONKEY_BOMB_JUMP_DOWN_DIR_STATE_END);
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_BOMB_BOMB_ATTACK",          CX2GUNPCFunc, MONKEY_BOMB_BOMB_ATTACK_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_BOMB_DAMAGE_SMALL",         CX2GUNPCFunc, MONKEY_BOMB_DAMAGE_SMALL_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_BOMB_DAMAGE_BIG",           CX2GUNPCFunc, MONKEY_BOMB_DAMAGE_BIG_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_BOMB_DAMAGE_DOWN_FRONT",    CX2GUNPCFunc, MONKEY_BOMB_DAMAGE_DOWN_FRONT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_BOMB_DAMAGE_DOWN_BACK",     CX2GUNPCFunc, MONKEY_BOMB_DAMAGE_DOWN_BACK_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_BOMB_DAMAGE_AIR_DOWN_LANDING", CX2GUNPCFunc, MONKEY_BOMB_DAMAGE_AIR_DOWN_LANDING_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_BOMB_STAND_UP_ATTACK_FRONT",CX2GUNPCFunc, MONKEY_BOMB_STAND_UP_ATTACK_FRONT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_BOMB_STAND_UP_ATTACK_BACK", CX2GUNPCFunc, MONKEY_BOMB_STAND_UP_ATTACK_BACK_FRAME_MOVE);
            SET_START_FUNC(         npcID, L"MONKEY_BOMB_DYING_LAND_FRONT",     CX2GUNPCFunc, MONKEY_BOMB_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"MONKEY_BOMB_DYING_LAND_BACK",      CX2GUNPCFunc, MONKEY_BOMB_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"MONKEY_BOMB_DYING_SKY",            CX2GUNPCFunc, MONKEY_BOMB_DYING_LAND_STATE_START);
        }
        break;

    case CX2UnitManager::NUI_SMALLGATE_GREEN:
        {
            SET_START_FUNC(         npcID, L"SMALL_GATE_GREEN_WAIT",            CX2GUNPCFunc, SMALL_GATE_GREEN_WAIT_START_STATE);
        }
        break;

    case CX2UnitManager::NUI_SMALLGATE_YELLOW:
        {
            SET_START_FUNC(         npcID, L"SMALL_GATE_YELLOW_WAIT",           CX2GUNPCFunc, SMALL_GATE_YELLOW_WAIT_START_STATE);
        }
        break;

    case CX2UnitManager::NUI_SMALLGATE_RED:
        {
            SET_START_FUNC(         npcID, L"SMALL_GATE_RED_WAIT",           CX2GUNPCFunc, SMALL_GATE_RED_WAIT_START_STATE);
        }
        break;

    case CX2UnitManager::NUI_SMALLGATE_POST:
        {
            SET_START_FUNC(         npcID, L"SMALL_GATE_POST_BROKEN",           CX2GUNPCFunc, SMALL_GATE_POST_BROKEN_START_STATE);
        }
        break;

    case CX2UnitManager::NUI_BENDERS_NORMAL:
        {            
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_WAIT",                     CX2GUNPCFunc, BENDERS_WAIT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_WALK",                     CX2GUNPCFunc, BENDERS_WALK_FRAME_MOVE);
            SET_END_FUNC(           npcID, L"BENDERS_WALK",                     CX2GUNPCFunc, BENDERS_WALK_STATE_END);
            SET_END_FUNC(           npcID, L"BENDERS_JUMP_DOWN",                CX2GUNPCFunc, BENDERS_JUMP_DOWN_STATE_END);
            SET_END_FUNC(           npcID, L"BENDERS_JUMP_DOWN_DIR",            CX2GUNPCFunc, BENDERS_JUMP_DOWN_DIR_STATE_END);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DASH",                     CX2GUNPCFunc, BENDERS_DASH_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_COMBO2",                   CX2GUNPCFunc, BENDERS_COMBO2_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_SUMMON_MONSTER",           CX2GUNPCFunc, BENDERS_SUMMON_MONSTER_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_SMALL",             CX2GUNPCFunc, BENDERS_DAMAGE_SMALL_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_BIG",               CX2GUNPCFunc, BENDERS_DAMAGE_BIG_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_DOWN_FRONT",        CX2GUNPCFunc, BENDERS_DAMAGE_DOWN_FRONT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_DOWN_BACK",         CX2GUNPCFunc, BENDERS_DAMAGE_DOWN_BACK_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_AIR_DOWN_LANDING",  CX2GUNPCFunc, BENDERS_DAMAGE_AIR_DOWN_LANDING_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_STAND_UP_ATTACK_FRONT",    CX2GUNPCFunc, BENDERS_STAND_UP_ATTACK_FRONT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_STAND_UP_ATTACK_BACK",     CX2GUNPCFunc, BENDERS_STAND_UP_ATTACK_BACK_FRAME_MOVE);
            SET_START_FUNC(         npcID, L"BENDERS_DYING_LAND_FRONT",         CX2GUNPCFunc, BENDERS_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"BENDERS_DYING_LAND_BACK",          CX2GUNPCFunc, BENDERS_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"BENDERS_DYING_SKY",                CX2GUNPCFunc, BENDERS_DYING_LAND_STATE_START);
        }
        break;

    case CX2UnitManager::NUI_BENDERS_HARD:
        {            
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_WAIT",                     CX2GUNPCFunc, BENDERS_HARD_WAIT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_WALK",                     CX2GUNPCFunc, BENDERS_HARD_WALK_FRAME_MOVE);
            SET_END_FUNC(           npcID, L"BENDERS_WALK",                     CX2GUNPCFunc, BENDERS_HARD_WALK_STATE_END);
            SET_END_FUNC(           npcID, L"BENDERS_JUMP_DOWN",                CX2GUNPCFunc, BENDERS_HARD_JUMP_DOWN_STATE_END);
            SET_END_FUNC(           npcID, L"BENDERS_JUMP_DOWN_DIR",            CX2GUNPCFunc, BENDERS_HARD_JUMP_DOWN_DIR_STATE_END);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DASH",                     CX2GUNPCFunc, BENDERS_HARD_DASH_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_COMBO2",                   CX2GUNPCFunc, BENDERS_HARD_COMBO2_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_SUMMON_MONSTER",           CX2GUNPCFunc, BENDERS_HARD_SUMMON_MONSTER_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_SMALL",             CX2GUNPCFunc, BENDERS_HARD_DAMAGE_SMALL_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_BIG",               CX2GUNPCFunc, BENDERS_HARD_DAMAGE_BIG_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_DOWN_FRONT",        CX2GUNPCFunc, BENDERS_HARD_DAMAGE_DOWN_FRONT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_DOWN_BACK",         CX2GUNPCFunc, BENDERS_HARD_DAMAGE_DOWN_BACK_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_AIR_DOWN_LANDING",  CX2GUNPCFunc, BENDERS_HARD_DAMAGE_AIR_DOWN_LANDING_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_STAND_UP_ATTACK_FRONT",    CX2GUNPCFunc, BENDERS_HARD_STAND_UP_ATTACK_FRONT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_STAND_UP_ATTACK_BACK",     CX2GUNPCFunc, BENDERS_HARD_STAND_UP_ATTACK_BACK_FRAME_MOVE);
            SET_START_FUNC(         npcID, L"BENDERS_DYING_LAND_FRONT",         CX2GUNPCFunc, BENDERS_HARD_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"BENDERS_DYING_LAND_BACK",          CX2GUNPCFunc, BENDERS_HARD_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"BENDERS_DYING_SKY",                CX2GUNPCFunc, BENDERS_HARD_DYING_LAND_STATE_START);
        }
        break;

    case CX2UnitManager::NUI_BENDERS_EXPERT:
        {            
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_WAIT",                     CX2GUNPCFunc, BENDERS_EXPERT_WAIT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_WALK",                     CX2GUNPCFunc, BENDERS_EXPERT_WALK_FRAME_MOVE);
            SET_END_FUNC(           npcID, L"BENDERS_WALK",                     CX2GUNPCFunc, BENDERS_EXPERT_WALK_STATE_END);
            SET_END_FUNC(           npcID, L"BENDERS_JUMP_DOWN",                CX2GUNPCFunc, BENDERS_EXPERT_JUMP_DOWN_STATE_END);
            SET_END_FUNC(           npcID, L"BENDERS_JUMP_DOWN_DIR",            CX2GUNPCFunc, BENDERS_EXPERT_JUMP_DOWN_DIR_STATE_END);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DASH",                     CX2GUNPCFunc, BENDERS_EXPERT_DASH_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_COMBO2",                   CX2GUNPCFunc, BENDERS_EXPERT_COMBO2_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_SUMMON_MONSTER",           CX2GUNPCFunc, BENDERS_EXPERT_SUMMON_MONSTER_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_SMALL",             CX2GUNPCFunc, BENDERS_EXPERT_DAMAGE_SMALL_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_BIG",               CX2GUNPCFunc, BENDERS_EXPERT_DAMAGE_BIG_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_DOWN_FRONT",        CX2GUNPCFunc, BENDERS_EXPERT_DAMAGE_DOWN_FRONT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_DOWN_BACK",         CX2GUNPCFunc, BENDERS_EXPERT_DAMAGE_DOWN_BACK_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_AIR_DOWN_LANDING",  CX2GUNPCFunc, BENDERS_EXPERT_DAMAGE_AIR_DOWN_LANDING_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_STAND_UP_ATTACK_FRONT",    CX2GUNPCFunc, BENDERS_EXPERT_STAND_UP_ATTACK_FRONT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_STAND_UP_ATTACK_BACK",     CX2GUNPCFunc, BENDERS_EXPERT_STAND_UP_ATTACK_BACK_FRAME_MOVE);
            SET_START_FUNC(         npcID, L"BENDERS_DYING_LAND_FRONT",         CX2GUNPCFunc, BENDERS_EXPERT_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"BENDERS_DYING_LAND_BACK",          CX2GUNPCFunc, BENDERS_EXPERT_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"BENDERS_DYING_SKY",                CX2GUNPCFunc, BENDERS_EXPERT_DYING_LAND_STATE_START);
        }
        break;
        
    case CX2UnitManager::NUI_BENDERS_B:
        {            
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_B_WAIT",                     CX2GUNPCFunc, BENDERS_B_WAIT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_B_WALK",                     CX2GUNPCFunc, BENDERS_B_WALK_FRAME_MOVE);
            SET_END_FUNC(           npcID, L"BENDERS_B_WALK",                     CX2GUNPCFunc, BENDERS_B_WALK_STATE_END);
            SET_END_FUNC(           npcID, L"BENDERS_B_JUMP_DOWN",                CX2GUNPCFunc, BENDERS_B_JUMP_DOWN_STATE_END);
            SET_END_FUNC(           npcID, L"BENDERS_B_JUMP_DOWN_DIR",            CX2GUNPCFunc, BENDERS_B_JUMP_DOWN_DIR_STATE_END);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_B_DASH",                     CX2GUNPCFunc, BENDERS_B_DASH_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_B_COMBO2",                   CX2GUNPCFunc, BENDERS_B_COMBO2_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_B_SUMMON_MONSTER",           CX2GUNPCFunc, BENDERS_B_SUMMON_MONSTER_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_B_DAMAGE_SMALL",             CX2GUNPCFunc, BENDERS_B_DAMAGE_SMALL_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_B_DAMAGE_BIG",               CX2GUNPCFunc, BENDERS_B_DAMAGE_BIG_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_B_DAMAGE_DOWN_FRONT",        CX2GUNPCFunc, BENDERS_B_DAMAGE_DOWN_FRONT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_B_DAMAGE_DOWN_BACK",         CX2GUNPCFunc, BENDERS_B_DAMAGE_DOWN_BACK_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_B_DAMAGE_AIR_DOWN_LANDING",  CX2GUNPCFunc, BENDERS_B_DAMAGE_AIR_DOWN_LANDING_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_B_STAND_UP_ATTACK_FRONT",    CX2GUNPCFunc, BENDERS_B_STAND_UP_ATTACK_FRONT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_B_STAND_UP_ATTACK_BACK",     CX2GUNPCFunc, BENDERS_B_STAND_UP_ATTACK_BACK_FRAME_MOVE);
            SET_START_FUNC(         npcID, L"BENDERS_B_DYING_LAND_FRONT",         CX2GUNPCFunc, BENDERS_B_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"BENDERS_B_DYING_LAND_BACK",          CX2GUNPCFunc, BENDERS_B_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"BENDERS_B_DYING_SKY",                CX2GUNPCFunc, BENDERS_B_DYING_LAND_STATE_START);
        }
        break;

    case CX2UnitManager::NUI_BENDERS_UPGRADE_NORMAL:
        {            
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_WAIT",                     CX2GUNPCFunc, BENDERS_UPGRADE_NORMAL_WAIT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_WALK",                     CX2GUNPCFunc, BENDERS_UPGRADE_NORMAL_WALK_FRAME_MOVE);
            SET_END_FUNC(           npcID, L"BENDERS_WALK",                     CX2GUNPCFunc, BENDERS_UPGRADE_NORMAL_WALK_STATE_END);
            SET_END_FUNC(           npcID, L"BENDERS_JUMP_DOWN",                CX2GUNPCFunc, BENDERS_UPGRADE_NORMAL_JUMP_DOWN_STATE_END);
            SET_END_FUNC(           npcID, L"BENDERS_JUMP_DOWN_DIR",            CX2GUNPCFunc, BENDERS_UPGRADE_NORMAL_JUMP_DOWN_DIR_STATE_END);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DASH",                     CX2GUNPCFunc, BENDERS_UPGRADE_NORMAL_DASH_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_COMBO2",                   CX2GUNPCFunc, BENDERS_UPGRADE_NORMAL_COMBO2_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_COMBO_A",                  CX2GUNPCFunc, BENDERS_UPGRADE_NORMAL_COMBO_A_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_SUMMON_MONSTER",           CX2GUNPCFunc, BENDERS_UPGRADE_NORMAL_SUMMON_MONSTER_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_SMALL",             CX2GUNPCFunc, BENDERS_UPGRADE_NORMAL_DAMAGE_SMALL_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_BIG",               CX2GUNPCFunc, BENDERS_UPGRADE_NORMAL_DAMAGE_BIG_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_DOWN_FRONT",        CX2GUNPCFunc, BENDERS_UPGRADE_NORMAL_DAMAGE_DOWN_FRONT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_DOWN_BACK",         CX2GUNPCFunc, BENDERS_UPGRADE_NORMAL_DAMAGE_DOWN_BACK_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_AIR_DOWN_LANDING",  CX2GUNPCFunc, BENDERS_UPGRADE_NORMAL_DAMAGE_AIR_DOWN_LANDING_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_STAND_UP_ATTACK_FRONT",    CX2GUNPCFunc, BENDERS_UPGRADE_NORMAL_STAND_UP_ATTACK_FRONT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_STAND_UP_ATTACK_BACK",     CX2GUNPCFunc, BENDERS_UPGRADE_NORMAL_STAND_UP_ATTACK_BACK_FRAME_MOVE);
            SET_START_FUNC(         npcID, L"BENDERS_DYING_LAND_FRONT",         CX2GUNPCFunc, BENDERS_UPGRADE_NORMAL_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"BENDERS_DYING_LAND_BACK",          CX2GUNPCFunc, BENDERS_UPGRADE_NORMAL_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"BENDERS_DYING_SKY",                CX2GUNPCFunc, BENDERS_UPGRADE_NORMAL_DYING_LAND_STATE_START);
        }
        break;

    case CX2UnitManager::NUI_BENDERS_UPGRADE_HARD:
        {            
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_WAIT",                     CX2GUNPCFunc, BENDERS_UPGRADE_HARD_WAIT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_WALK",                     CX2GUNPCFunc, BENDERS_UPGRADE_HARD_WALK_FRAME_MOVE);
            SET_END_FUNC(           npcID, L"BENDERS_WALK",                     CX2GUNPCFunc, BENDERS_UPGRADE_HARD_WALK_STATE_END);
            SET_END_FUNC(           npcID, L"BENDERS_JUMP_DOWN",                CX2GUNPCFunc, BENDERS_UPGRADE_HARD_JUMP_DOWN_STATE_END);
            SET_END_FUNC(           npcID, L"BENDERS_JUMP_DOWN_DIR",            CX2GUNPCFunc, BENDERS_UPGRADE_HARD_JUMP_DOWN_DIR_STATE_END);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DASH",                     CX2GUNPCFunc, BENDERS_UPGRADE_HARD_DASH_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_COMBO2",                   CX2GUNPCFunc, BENDERS_UPGRADE_HARD_COMBO2_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_COMBO_A",                  CX2GUNPCFunc, BENDERS_UPGRADE_HARD_COMBO_A_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_SUMMON_MONSTER",           CX2GUNPCFunc, BENDERS_UPGRADE_HARD_SUMMON_MONSTER_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_SMALL",             CX2GUNPCFunc, BENDERS_UPGRADE_HARD_DAMAGE_SMALL_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_BIG",               CX2GUNPCFunc, BENDERS_UPGRADE_HARD_DAMAGE_BIG_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_DOWN_FRONT",        CX2GUNPCFunc, BENDERS_UPGRADE_HARD_DAMAGE_DOWN_FRONT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_DOWN_BACK",         CX2GUNPCFunc, BENDERS_UPGRADE_HARD_DAMAGE_DOWN_BACK_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_AIR_DOWN_LANDING",  CX2GUNPCFunc, BENDERS_UPGRADE_HARD_DAMAGE_AIR_DOWN_LANDING_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_STAND_UP_ATTACK_FRONT",    CX2GUNPCFunc, BENDERS_UPGRADE_HARD_STAND_UP_ATTACK_FRONT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_STAND_UP_ATTACK_BACK",     CX2GUNPCFunc, BENDERS_UPGRADE_HARD_STAND_UP_ATTACK_BACK_FRAME_MOVE);
            SET_START_FUNC(         npcID, L"BENDERS_DYING_LAND_FRONT",         CX2GUNPCFunc, BENDERS_UPGRADE_HARD_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"BENDERS_DYING_LAND_BACK",          CX2GUNPCFunc, BENDERS_UPGRADE_HARD_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"BENDERS_DYING_SKY",                CX2GUNPCFunc, BENDERS_UPGRADE_HARD_DYING_LAND_STATE_START);
        }
        break;

    case CX2UnitManager::NUI_BENDERS_UPGRADE_EXPERT:
        {            
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_WAIT",                     CX2GUNPCFunc, BENDERS_UPGRADE_EXPERT_WAIT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_WALK",                     CX2GUNPCFunc, BENDERS_UPGRADE_EXPERT_WALK_FRAME_MOVE);
            SET_END_FUNC(           npcID, L"BENDERS_WALK",                     CX2GUNPCFunc, BENDERS_UPGRADE_EXPERT_WALK_STATE_END);
            SET_END_FUNC(           npcID, L"BENDERS_JUMP_DOWN",                CX2GUNPCFunc, BENDERS_UPGRADE_EXPERT_JUMP_DOWN_STATE_END);
            SET_END_FUNC(           npcID, L"BENDERS_JUMP_DOWN_DIR",            CX2GUNPCFunc, BENDERS_UPGRADE_EXPERT_JUMP_DOWN_DIR_STATE_END);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DASH",                     CX2GUNPCFunc, BENDERS_UPGRADE_EXPERT_DASH_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_COMBO2",                   CX2GUNPCFunc, BENDERS_UPGRADE_EXPERT_COMBO2_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_COMBO_A",                  CX2GUNPCFunc, BENDERS_UPGRADE_EXPERT_COMBO_A_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_SUMMON_MONSTER",           CX2GUNPCFunc, BENDERS_UPGRADE_EXPERT_SUMMON_MONSTER_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_SMALL",             CX2GUNPCFunc, BENDERS_UPGRADE_EXPERT_DAMAGE_SMALL_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_BIG",               CX2GUNPCFunc, BENDERS_UPGRADE_EXPERT_DAMAGE_BIG_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_DOWN_FRONT",        CX2GUNPCFunc, BENDERS_UPGRADE_EXPERT_DAMAGE_DOWN_FRONT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_DOWN_BACK",         CX2GUNPCFunc, BENDERS_UPGRADE_EXPERT_DAMAGE_DOWN_BACK_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_DAMAGE_AIR_DOWN_LANDING",  CX2GUNPCFunc, BENDERS_UPGRADE_EXPERT_DAMAGE_AIR_DOWN_LANDING_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_STAND_UP_ATTACK_FRONT",    CX2GUNPCFunc, BENDERS_UPGRADE_EXPERT_STAND_UP_ATTACK_FRONT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"BENDERS_STAND_UP_ATTACK_BACK",     CX2GUNPCFunc, BENDERS_UPGRADE_EXPERT_STAND_UP_ATTACK_BACK_FRAME_MOVE);
            SET_START_FUNC(         npcID, L"BENDERS_DYING_LAND_FRONT",         CX2GUNPCFunc, BENDERS_UPGRADE_EXPERT_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"BENDERS_DYING_LAND_BACK",          CX2GUNPCFunc, BENDERS_UPGRADE_EXPERT_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"BENDERS_DYING_SKY",                CX2GUNPCFunc, BENDERS_UPGRADE_EXPERT_DYING_LAND_STATE_START);
        }
        break;

    case CX2UnitManager::NUI_CHAINGATE_GREEN:
        {
            SET_START_FUNC(         npcID, L"CHAIN_GATE_GREEN_WAIT",            CX2GUNPCFunc, CHAIN_GATE_GREEN_WAIT_START_STATE);
        }
        break;

    case CX2UnitManager::NUI_CHAINGATE_YELLOW:
        {
            SET_START_FUNC(         npcID, L"CHAIN_GATE_YELLOW_WAIT",            CX2GUNPCFunc, CHAIN_GATE_YELLOW_WAIT_START_STATE);
        }
        break;

    case CX2UnitManager::NUI_CHAINGATE_RED:
        {
            SET_START_FUNC(         npcID, L"CHAIN_GATE_GREEN_WAIT",            CX2GUNPCFunc, CHAIN_GATE_RED_WAIT_START_STATE);
        }
        break;

    case CX2UnitManager::NUI_CHAINGATE_EXTRA:
        {
            SET_START_FUNC(         npcID, L"CHAIN_GATE_GREEN_WAIT",            CX2GUNPCFunc, CHAIN_GATE_EXTRA_WAIT_START_STATE);
        }
        break;
         
    case CX2UnitManager::NUI_CHAINGATE_POST:
        {
            SET_START_FUNC(         npcID, L"CHAIN_GATE_POST_BROKEN",           CX2GUNPCFunc, CHAIN_GATE_POST_BROKEN_START_STATE);
        }
        break;

    case CX2UnitManager::NUI_CHAINGATE_POST_EXTRA:
        {
            SET_START_FUNC(         npcID, L"CHAIN_GATE_POST_BROKEN",           CX2GUNPCFunc, CHAIN_GATE_POST_EXTRA_BROKEN_START_STATE);
        }
        break;
    ...
    case CX2UnitManager::NUI_MONKEY_BOSS_EASY:
        {
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_BOSS_WAIT2",                CX2GUNPCFunc, MONKEY_BOSS_WAIT2_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_BOSS_WAIT3",                CX2GUNPCFunc, MONKEY_BOSS_WAIT3_FRAME_MOVE);
            SET_END_FUNC(           npcID, L"MONKEY_BOSS_WALK",                 CX2GUNPCFunc, MONKEY_BOSS_WALK_STATE_END);
            SET_END_FUNC(           npcID, L"MONKEY_BOSS_JUMP_DOWN",            CX2GUNPCFunc, MONKEY_BOSS_JUMP_DOWN_STATE_END);
            SET_END_FUNC(           npcID, L"MONKEY_BOSS_JUMP_DOWN_DIR",        CX2GUNPCFunc, MONKEY_BOSS_JUMP_DOWN_DIR_STATE_END);
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_BOSS_PUNCH_PUNCH_ATTACK",   CX2GUNPCFunc, MONKEY_BOSS_PUNCH_PUNCH_ATTACK_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_BOSS_DAMAGE_SMALL",         CX2GUNPCFunc, MONKEY_BOSS_DAMAGE_SMALL_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_BOSS_DAMAGE_BIG",           CX2GUNPCFunc, MONKEY_BOSS_DAMAGE_BIG_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_BOSS_DAMAGE_DOWN_FRONT",    CX2GUNPCFunc, MONKEY_BOSS_DAMAGE_DOWN_FRONT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_BOSS_DAMAGE_DOWN_BACK",     CX2GUNPCFunc, MONKEY_BOSS_DAMAGE_DOWN_BACK_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_BOSS_DAMAGE_AIR_DOWN_LANDING", CX2GUNPCFunc, MONKEY_BOSS_DAMAGE_AIR_DOWN_LANDING_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_BOSS_STAND_UP_ATTACK_FRONT", CX2GUNPCFunc, MONKEY_BOSS_STAND_UP_ATTACK_FRONT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_BOSS_STAND_UP_ATTACK_BACK", CX2GUNPCFunc, MONKEY_BOSS_STAND_UP_ATTACK_BACK_FRAME_MOVE);
            SET_START_FUNC(         npcID, L"MONKEY_BOSS_DYING_LAND_FRONT",     CX2GUNPCFunc, MONKEY_BOSS_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"MONKEY_BOSS_DYING_LAND_BACK",      CX2GUNPCFunc, MONKEY_BOSS_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"MONKEY_BOSS_DYING_SKY",            CX2GUNPCFunc, MONKEY_BOSS_DYING_LAND_STATE_START);
        }
        break;

	case CX2UnitManager::NUI_MONKEY_ROLLING:
		{
			SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_ROLLING_WAIT2",                CX2GUNPCFunc, MONKEY_BOSS_WAIT2_FRAME_MOVE);
			SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_ROLLING_WAIT3",                CX2GUNPCFunc, MONKEY_BOSS_WAIT3_FRAME_MOVE);
			SET_END_FUNC(           npcID, L"MONKEY_ROLLING_WALK",                 CX2GUNPCFunc, MONKEY_BOSS_WALK_STATE_END);
			SET_END_FUNC(           npcID, L"MONKEY_ROLLING_JUMP_DOWN",            CX2GUNPCFunc, MONKEY_BOSS_JUMP_DOWN_STATE_END);
			SET_END_FUNC(           npcID, L"MONKEY_ROLLING_JUMP_DOWN_DIR",        CX2GUNPCFunc, MONKEY_BOSS_JUMP_DOWN_DIR_STATE_END);
			SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_ROLLING_PUNCH_PUNCH_ATTACK",   CX2GUNPCFunc, MONKEY_BOSS_PUNCH_PUNCH_ATTACK_FRAME_MOVE);
			SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_ROLLING_DAMAGE_SMALL",         CX2GUNPCFunc, MONKEY_BOSS_DAMAGE_SMALL_FRAME_MOVE);
			SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_ROLLING_DAMAGE_BIG",           CX2GUNPCFunc, MONKEY_BOSS_DAMAGE_BIG_FRAME_MOVE);
			SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_ROLLING_DAMAGE_DOWN_FRONT",    CX2GUNPCFunc, MONKEY_BOSS_DAMAGE_DOWN_FRONT_FRAME_MOVE);
			SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_ROLLING_DAMAGE_DOWN_BACK",     CX2GUNPCFunc, MONKEY_BOSS_DAMAGE_DOWN_BACK_FRAME_MOVE);
			SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_ROLLING_DAMAGE_AIR_DOWN_LANDING", CX2GUNPCFunc, MONKEY_BOSS_DAMAGE_AIR_DOWN_LANDING_FRAME_MOVE);
			SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_ROLLING_STAND_UP_ATTACK_FRONT", CX2GUNPCFunc, MONKEY_BOSS_STAND_UP_ATTACK_FRONT_FRAME_MOVE);
			SET_FRAME_MOVE_FUNC(    npcID, L"MONKEY_ROLLING_STAND_UP_ATTACK_BACK", CX2GUNPCFunc, MONKEY_BOSS_STAND_UP_ATTACK_BACK_FRAME_MOVE);
			SET_START_FUNC(         npcID, L"MONKEY_ROLLING_DYING_LAND_FRONT",     CX2GUNPCFunc, MONKEY_BOSS_DYING_LAND_STATE_START);
			SET_START_FUNC(         npcID, L"MONKEY_ROLLING_DYING_LAND_BACK",      CX2GUNPCFunc, MONKEY_BOSS_DYING_LAND_STATE_START);
			SET_START_FUNC(         npcID, L"MONKEY_ROLLING_DYING_SKY",            CX2GUNPCFunc, MONKEY_BOSS_DYING_LAND_STATE_START);
		} break;

    case CX2UnitManager::NUI_MUSHROOM:
        {
            SET_FRAME_MOVE_FUNC(    npcID, L"MUSHROOM_WALK",                    CX2GUNPCFunc, MUSHROOM_WALK_FRAME_MOVE);
            SET_END_FUNC(           npcID, L"MUSHROOM_WALK",                    CX2GUNPCFunc, MUSHROOM_WALK_STATE_END);
            SET_END_FUNC(           npcID, L"MUSHROOM_JUMP_DOWN",               CX2GUNPCFunc, MUSHROOM_JUMP_DOWN_STATE_END);
            SET_END_FUNC(           npcID, L"MUSHROOM_JUMP_DOWN_DIR",           CX2GUNPCFunc, MUSHROOM_JUMP_DOWN_DIR_STATE_END);
            SET_FRAME_MOVE_FUNC(    npcID, L"MUSHROOM_DAMAGE",                  CX2GUNPCFunc, MUSHROOM_DAMAGE_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"MUSHROOM_DAMAGE_DOWN_FRONT",       CX2GUNPCFunc, MUSHROOM_DAMAGE_DOWN_FRONT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"MUSHROOM_DAMAGE_DOWN_BACK",        CX2GUNPCFunc, MUSHROOM_DAMAGE_DOWN_BACK_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"MUSHROOM_DAMAGE_AIR_DOWN_LANDING", CX2GUNPCFunc, MUSHROOM_DAMAGE_AIR_DOWN_LANDING_FRAME_MOVE);
            SET_START_FUNC(         npcID, L"MUSHROOM_DYING_LAND_FRONT",        CX2GUNPCFunc, MUSHROOM_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"MUSHROOM_DYING_LAND_BACK",         CX2GUNPCFunc, MUSHROOM_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"MUSHROOM_DYING_SKY",               CX2GUNPCFunc, MUSHROOM_DYING_LAND_STATE_START);
        }
        break;
//{{ oasis907 : ±ËªÛ¿± [2010.10.21] // «“∑Œ¿© ∏”Ω¨∑Î
	case CX2UnitManager::NUI_HALLOWEEN_MUSHROOM:
		...
		break;
//}} oasis907 : ±ËªÛ¿± [2010.10.21] // 
    case CX2UnitManager::NUI_MUSHROOM_EASY:
        {
            SET_FRAME_MOVE_FUNC(    npcID, L"MUSHROOM_EASY_WALK",                    CX2GUNPCFunc, MUSHROOM_WALK_FRAME_MOVE);
            SET_END_FUNC(           npcID, L"MUSHROOM_EASY_WALK",                    CX2GUNPCFunc, MUSHROOM_WALK_STATE_END);
            SET_END_FUNC(           npcID, L"MUSHROOM_EASY_JUMP_DOWN",               CX2GUNPCFunc, MUSHROOM_JUMP_DOWN_STATE_END);
            SET_END_FUNC(           npcID, L"MUSHROOM_EASY_JUMP_DOWN_DIR",           CX2GUNPCFunc, MUSHROOM_JUMP_DOWN_DIR_STATE_END);
            SET_FRAME_MOVE_FUNC(    npcID, L"MUSHROOM_EASY_DAMAGE",                  CX2GUNPCFunc, MUSHROOM_DAMAGE_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"MUSHROOM_EASY_DAMAGE_DOWN_FRONT",       CX2GUNPCFunc, MUSHROOM_DAMAGE_DOWN_FRONT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"MUSHROOM_EASY_DAMAGE_DOWN_BACK",        CX2GUNPCFunc, MUSHROOM_DAMAGE_DOWN_BACK_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"MUSHROOM_EASY_DAMAGE_AIR_DOWN_LANDING", CX2GUNPCFunc, MUSHROOM_DAMAGE_AIR_DOWN_LANDING_FRAME_MOVE);
            SET_START_FUNC(         npcID, L"MUSHROOM_EASY_DYING_LAND_FRONT",        CX2GUNPCFunc, MUSHROOM_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"MUSHROOM_EASY_DYING_LAND_BACK",         CX2GUNPCFunc, MUSHROOM_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"MUSHROOM_EASY_DYING_SKY",               CX2GUNPCFunc, MUSHROOM_DYING_LAND_STATE_START);
        }
        break;

    case CX2UnitManager::NUI_MUSHROOM_WOODEN:
        {
            SET_FRAME_MOVE_FUNC(    npcID, L"MUSHROOM_WOODEN_WALK",             CX2GUNPCFunc, MUSHROOM_WOODEN_WALK_FRAME_MOVE);
            SET_END_FUNC(           npcID, L"MUSHROOM_WOODEN_WALK",             CX2GUNPCFunc, MUSHROOM_WOODEN_WALK_STATE_END);
            SET_END_FUNC(           npcID, L"MUSHROOM_WOODEN_JUMP_DOWN",        CX2GUNPCFunc, MUSHROOM_WOODEN_JUMP_DOWN_STATE_END);
            SET_END_FUNC(           npcID, L"MUSHROOM_WOODEN_JUMP_DOWN_DIR",    CX2GUNPCFunc, MUSHROOM_WOODEN_JUMP_DOWN_DIR_STATE_END);
            SET_FRAME_MOVE_FUNC(    npcID, L"MUSHROOM_WOODEN_DAMAGE",           CX2GUNPCFunc, MUSHROOM_WOODEN_DAMAGE_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"MUSHROOM_WOODEN_DAMAGE_DOWN_FRONT",CX2GUNPCFunc, MUSHROOM_WOODEN_DAMAGE_DOWN_FRONT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"MUSHROOM_WOODEN_DAMAGE_DOWN_BACK", CX2GUNPCFunc, MUSHROOM_WOODEN_DAMAGE_DOWN_BACK_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"MUSHROOM_WOODEN_DAMAGE_AIR_DOWN_LANDING", CX2GUNPCFunc, MUSHROOM_WOODEN_DAMAGE_AIR_DOWN_LANDING_FRAME_MOVE);
            SET_START_FUNC(         npcID, L"MUSHROOM_WOODEN_DYING_LAND_FRONT", CX2GUNPCFunc, MUSHROOM_WOODEN_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"MUSHROOM_WOODEN_DYING_LAND_BACK",  CX2GUNPCFunc, MUSHROOM_WOODEN_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"MUSHROOM_WOODEN_DYING_SKY",        CX2GUNPCFunc, MUSHROOM_WOODEN_DYING_LAND_STATE_START);
        }
        break;

    case CX2UnitManager::NUI_PPORU_WILLIAM_NORMAL:
        {
            SET_FRAME_MOVE_FUNC(    npcID, L"WILLIAM_PPORU_WAIT",               CX2GUNPCFunc, WILLIAM_PPORU_WAIT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"WILLIAM_PPORU_WALK",               CX2GUNPCFunc, WILLIAM_PPORU_WALK_FRAME_MOVE);
            SET_END_FUNC(           npcID, L"WILLIAM_PPORU_WALK",               CX2GUNPCFunc, WILLIAM_PPORU_WALK_STATE_END);
            SET_FRAME_MOVE_FUNC(    npcID, L"WILLIAM_PPORU_DASH",               CX2GUNPCFunc, WILLIAM_PPORU_DASH_FRAME_MOVE);
            SET_START_FUNC(         npcID, L"WILLIAM_PPORU_DASH_END",           CX2GUNPCFunc, WILLIAM_PPORU_DASH_END_STATE_START);
            SET_END_FUNC(           npcID, L"WILLIAM_PPORU_JUMP_DOWN",          CX2GUNPCFunc, WILLIAM_PPORU_JUMP_DOWN_STATE_END);
            SET_END_FUNC(           npcID, L"WILLIAM_PPORU_JUMP_DOWN_DIR",      CX2GUNPCFunc, WILLIAM_PPORU_JUMP_DOWN_DIR_STATE_END);
            SET_FRAME_MOVE_FUNC(    npcID, L"WILLIAM_PPORU_COMBO_ATTACK_A",     CX2GUNPCFunc, WILLIAM_PPORU_COMBO_ATTACK_A_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"WILLIAM_PPORU_DAMAGE_SMALL",       CX2GUNPCFunc, WILLIAM_PPORU_DAMAGE_SMALL_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"WILLIAM_PPORU_DAMAGE_BIG",         CX2GUNPCFunc, WILLIAM_PPORU_DAMAGE_BIG_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"WILLIAM_PPORU_DAMAGE_DOWN_FRONT",  CX2GUNPCFunc, WILLIAM_PPORU_DAMAGE_DOWN_FRONT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"WILLIAM_PPORU_DAMAGE_DOWN_BACK",   CX2GUNPCFunc, WILLIAM_PPORU_DAMAGE_DOWN_BACK_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"WILLIAM_PPORU_DAMAGE_AIR_DOWN_LANDING",CX2GUNPCFunc, WILLIAM_PPORU_DAMAGE_AIR_DOWN_LANDING_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"WILLIAM_PPORU_STAND_UP_ATTACK_FRONT",  CX2GUNPCFunc, WILLIAM_PPORU_STAND_UP_ATTACK_FRONT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"WILLIAM_PPORU_STAND_UP_ATTACK_BACK",   CX2GUNPCFunc, WILLIAM_PPORU_STAND_UP_ATTACK_BACK_FRAME_MOVE);
            SET_START_FUNC(         npcID, L"WILLIAM_PPORU_DYING_LAND_FRONT",   CX2GUNPCFunc, WILLIAM_PPORU_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"WILLIAM_PPORU_DYING_LAND_BACK",    CX2GUNPCFunc, WILLIAM_PPORU_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"WILLIAM_PPORU_DYING_SKY",          CX2GUNPCFunc, WILLIAM_PPORU_DYING_LAND_STATE_START);
        }
        break;

    case CX2UnitManager::NUI_PPORU_WILLIAM_HARD:
        {
            SET_FRAME_MOVE_FUNC(    npcID, L"WILLIAM_PPORU_WAIT",               CX2GUNPCFunc, WILLIAM_PPORU_HARD_WAIT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"WILLIAM_PPORU_WALK",               CX2GUNPCFunc, WILLIAM_PPORU_HARD_WALK_FRAME_MOVE);
            SET_END_FUNC(           npcID, L"WILLIAM_PPORU_WALK",               CX2GUNPCFunc, WILLIAM_PPORU_HARD_WALK_STATE_END);
            SET_FRAME_MOVE_FUNC(    npcID, L"WILLIAM_PPORU_DASH",               CX2GUNPCFunc, WILLIAM_PPORU_HARD_DASH_FRAME_MOVE);
            SET_START_FUNC(         npcID, L"WILLIAM_PPORU_DASH_END",           CX2GUNPCFunc, WILLIAM_PPORU_HARD_DASH_END_STATE_START);
            SET_END_FUNC(           npcID, L"WILLIAM_PPORU_JUMP_DOWN",          CX2GUNPCFunc, WILLIAM_PPORU_HARD_JUMP_DOWN_STATE_END);
            SET_END_FUNC(           npcID, L"WILLIAM_PPORU_JUMP_DOWN_DIR",      CX2GUNPCFunc, WILLIAM_PPORU_HARD_JUMP_DOWN_DIR_STATE_END);
            SET_FRAME_MOVE_FUNC(    npcID, L"WILLIAM_PPORU_ATTACK",             CX2GUNPCFunc, WILLIAM_PPORU_HARD_ATTACK_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"WILLIAM_PPORU_COMBO_ATTACK_A",     CX2GUNPCFunc, WILLIAM_PPORU_HARD_COMBO_ATTACK_A_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"WILLIAM_PPORU_DAMAGE_SMALL",       CX2GUNPCFunc, WILLIAM_PPORU_HARD_DAMAGE_SMALL_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"WILLIAM_PPORU_DAMAGE_BIG",         CX2GUNPCFunc, WILLIAM_PPORU_HARD_DAMAGE_BIG_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"WILLIAM_PPORU_DAMAGE_DOWN_FRONT",  CX2GUNPCFunc, WILLIAM_PPORU_HARD_DAMAGE_DOWN_FRONT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"WILLIAM_PPORU_DAMAGE_DOWN_BACK",   CX2GUNPCFunc, WILLIAM_PPORU_HARD_DAMAGE_DOWN_BACK_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"WILLIAM_PPORU_DAMAGE_AIR_DOWN_LANDING",CX2GUNPCFunc, WILLIAM_PPORU_HARD_DAMAGE_AIR_DOWN_LANDING_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"WILLIAM_PPORU_STAND_UP_ATTACK_FRONT",  CX2GUNPCFunc, WILLIAM_PPORU_HARD_STAND_UP_ATTACK_FRONT_FRAME_MOVE);
            SET_FRAME_MOVE_FUNC(    npcID, L"WILLIAM_PPORU_STAND_UP_ATTACK_BACK",   CX2GUNPCFunc, WILLIAM_PPORU_HARD_STAND_UP_ATTACK_BACK_FRAME_MOVE);
            SET_START_FUNC(         npcID, L"WILLIAM_PPORU_DYING_LAND_FRONT",   CX2GUNPCFunc, WILLIAM_PPORU_HARD_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"WILLIAM_PPORU_DYING_LAND_BACK",    CX2GUNPCFunc, WILLIAM_PPORU_HARD_DYING_LAND_STATE_START);
            SET_START_FUNC(         npcID, L"WILLIAM_PPORU_DYING_SKY",          CX2GUNPCFunc, WILLIAM_PPORU_HARD_DYING_LAND_STATE_START);
        }
        break;
        
	case CX2UnitManager::NUI_PPORU_GIANT_RED:
		{
			SET_FRAME_MOVE_FUNC(	npcID, L"GIANT_PPORU_RED_SPECIAL_ATTACK_A",	CX2GUNPCFunc, GIANT_PPORU_RED_SPECIAL_ATTACK_A_FRAME_MOVE );
		}
		break;

	case CX2UnitManager::NUI_PPORU_GIANT_BLACK:
		{
			SET_FRAME_MOVE_FUNC(	npcID, L"GIANT_PPORU_BLACK_SPECIAL_ATTACK_A",	CX2GUNPCFunc, GIANT_PPORU_RED_SPECIAL_ATTACK_A_FRAME_MOVE );
		}
		break;

	case CX2UnitManager::NUI_PPORU_GIANT_WHITE:
		{
			SET_FRAME_MOVE_FUNC(	npcID, L"GIANT_PPORU_WHITE_SPECIAL_ATTACK_A",	CX2GUNPCFunc, GIANT_PPORU_RED_SPECIAL_ATTACK_A_FRAME_MOVE );
		}
		break;
	...
	case CX2UnitManager::NUI_BAT_A:
		{
			SET_START_FUNC(				npcID, L"BAT_A_FLY",	CX2GUNPCFunc, BAT_A_FLY_STATE_START );
			SET_FRAME_MOVE_FUNC(		npcID, L"BAT_A_FLY",	CX2GUNPCFunc, BAT_A_FLY_FRAME_MOVE );
		}
		break;
...
void CX2GUNPCFunc::MONKEY_APPLE_RIDE_HORSE_FRAME_MOVE( CX2GUNPC* pNPCUnit )
{
	...
	if ( pRidingNPC != NULL )
	{
		...
		if ( pRidingNPC->GetNowHp() <= 0 )
		{
			...
			pNPCUnit->StateChange( L"MONKEY_APPLE_LEAVE_HORSE" );
		}
	}
}
...
void CX2GUNPCFunc::BARRIER_CREATEMACHINE_FIRE_COMMON_FRAME_MOVE( CX2GUNPC* pNPCUnit  )
{
	...
	if( pNPCUnit->AnimEventTimer_LUA( 0.02f) )
	{
		...
		if( fDist > 1800.f )
		{
			pNPC_ELE_Fire->StateChange( L"NASOD_ELEMENT_FIRE_TELEPORT" );
		}
	}
}
...
{    
	...
	if( pNPCUnit->AnimEventTimer_LUA( 0.02f) )
	{
		...
		if( fDist > 1800.f )
		{
			pNPC_ELE_ICE->StateChange( L"NASOD_ELEMENT_ICE_TELEPORT" );
		}
	}
}
...
void CX2GUNPCFunc::NASOD_ELEMENT_FIRE_COMMON_FRAME_MOVE( CX2GUNPC* pNPCUnit  )
{
		...
		true == bLiveBarrierMachine )
	{
		...
		if( INVALID_PARTICLE_HANDLE != pNPCUnit->GetMajorParticleHandle(1) )
		{
			if( NULL != pSeq1 )
			{
...
void CX2GUNPCFunc::MONSTER_FLY_FRAME_MOVE( CX2GUNPC* pNPCUnit )
{
	...
	//x√‡¿Ã≥™ z√‡¿∏∑Œ æÛ∏∂≥™ ∫Ò∆≤æÓ¡Æº≠ ≥Øæ∆∞°¥¬∞≈¡ˆ?
	D3DXMATRIX matTrans;
	D3DXMatrixIdentity( &matTrans );
	D3DXMatrixRotationY( &matTrans, D3DXToRadian( 90 ) );
	D3DXVECTOR3 tempDirVec;	//πŸ∂Û∫∏¥¬ ∞≈Ω√±‚∂˚ ºˆ¡˜¿Ã µ«¥¬ πÊ«‚∫§≈Õ ∞˙ø¨ ¿Ã∞‘ 90µµ∑Œ ≤™¿∫∞‘ ∏¬¿ª±Ó?
...
void CX2GUNPCFunc::MONSTER_FLY_START_CALCULATE( CX2GUNPC* pNPCUnit, float fTime, float fAdjustHeight, CX2GameUnit* pGameUnit_ )
{
	...
	//ƒ≥∏Ø≈Õ ¿ßƒ°∞° ø¯¡°¿ßƒ°∂Û∞Ì ∫∏∞Ì ø£««ææ∏¶ πŸ∂Û∫º±Ó?
	...
	*/
	...
	//√÷¥Î∞° 45µµ¿Ã∞Ì √÷º“∞° 10µµ¿Œµ•.. ¿∏»Ï.. æÓ∂±«œ∏È ¡¡¿ª±Ó≥∂?
