...
class CX2DungeonRoom : public CX2Room
{
	...
	public:
		...
		CX2Dungeon::DUNGEON_ID			GetDungeonID() const	{ return m_DungeonID;			}

		void							SetDifficulty( CX2Dungeon::DIFFICULTY_LEVEL difficultyLevel )	{ m_DifficultyLevel		= difficultyLevel;	}
		void							SetDungeonID( CX2Dungeon::DUNGEON_ID dungeonID )				{ m_DungeonID			= dungeonID;		}
		...
		bool							IsDefenceDungeon( CX2Dungeon::DUNGEON_ID eDungeonID );
