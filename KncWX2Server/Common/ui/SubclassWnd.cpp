 ...
 */
const UINT WM_UNSUBCLASS = RegisterWindowMessage(L"{207D9568-FF3C-11D3-A469-000629B2F855}");
/*
 * Message used to reflect messages back to child controls.
 */
const UINT WM_REFLECT = RegisterWindowMessage(L"{9688DAE5-3736-11D4-A48C-000629B2F855}");
/*
 * Message used to get the reflector plugin from a window if one exists.
 */
const UINT WM_GETREFLECTOR = RegisterWindowMessage(L"{9688DAE6-3736-11D4-A48C-000629B2F855}");
