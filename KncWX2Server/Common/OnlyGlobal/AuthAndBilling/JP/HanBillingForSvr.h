...
#define HAN_BILLING_INITED_FAILBILLNOACC  -17  // 2009-06-22
#define HAN_BILLING_GETCONN_FAILBILLNOACC -18  // 2009-06-22
...
//
// HanBillingGetBillNo (Japan only. 2009-01-09)
//
...
//
// HanBillingGetBillNoAcc (Japan only. 2009-06-16)
//
HANBILLING_API int __stdcall HanBillingGetBillNoAcc(/*IN*/  const char *szAccId,
                                                    /*OUT*/ char *szBillNo,
                                                    /*OUT*/ char *szRetMsg,
                                                    /*IN*/  int nRetMsg_size);
