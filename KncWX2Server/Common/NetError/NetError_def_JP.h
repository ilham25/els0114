...
enum NetErrorEnum
{
	...
	ERR_NX_COUPON_00,             //이미 사용된 시리얼 코드입니다.
	...
	ERR_DELETE_UNIT_01,             //이미 삭제되었거나 삭제 대기 상태의 캐릭입니다.
	ERR_DELETE_UNIT_02,             //캐릭터 삭제 가능한 기간이 아닙니다.
	ERR_DELETE_UNIT_03,             //캐릭터 최종 삭제 가능 기간이 아닙니다.
	ERR_DELETE_UNIT_04,             //최종 삭제 가능한 캐릭터가 아닙니다.
...
static wchar_t* szErrorStr[] = {
	...
	L"이미 삭제되었거나 삭제 대기 상태의 캐릭입니다.",
	L"캐릭터 삭제 가능한 기간이 아닙니다.",
	L"캐릭터 최종 삭제 가능 기간이 아닙니다.",
	L"최종 삭제 가능한 캐릭터가 아닙니다.",
...
static wchar_t* szErrorStrF[] = {
	...
	L"캐릭터 최종 삭제 가능 기간이 아닙니다.",
	L"최종 삭제 가능한 캐릭터가 아닙니다.",
	L"삭제 복구 대상 캐릭터가 아닙니다.",
	L"캐릭터 복구 가능 기간이 아닙니다.",
	L"しばらくしてから再度お試しください。",
	L"該当キャラクターが見つかりません。",
	L"キャラクターの削除に失敗しました。",
	L"ペット名の変更に失敗しました。",
	...
	L"レベルグループが違うプレイヤーとはプレイできません。",
	L"違法プレイヤー検査システムによるパーティ離脱です。",
	L"パーティ再結合によるパーティ離脱です。",
	L"有効ではないパーティメンバー検査によるパーティ離脱です。",
	L"闇の門進入前離脱によるパーティ離脱です。",
	L"",
	L"使用できないニックネームです。",
	L"禁止語が含まれています。",
	L"間違った名前を入力しました。",
	L"ナソードメガホンメッセージに使用できない単語が\n含まれています。もう一度作成してください。",
	L"間違った名前を入力しました。",
	L"運営チームと誤解される内容を含んでいるため、発送が制限されます。",
	L"写真は1日に1枚のみ確認できます。",
	L"正常に写真を開けませんでした。もう一度選択してください。",
