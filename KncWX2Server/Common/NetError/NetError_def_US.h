...
enum NetErrorEnum
{
	...
	ERR_4TH_ANNIV_EVENT_01,             //하루에 한장의 사진만 확인이 가능합니다.
	ERR_4TH_ANNIV_EVENT_02,             //잘못된 사진이 선택되었습니다. 다시 한번 시도해 보세요.
	ERR_KNM_07,             //모든 서버군에서 캐릭터를 찾지 못했습니다.
...
static wchar_t* szErrorStr[] = {
	...
	L"하루에 한장의 사진만 확인이 가능합니다.",
	L"잘못된 사진이 선택되었습니다. 다시 한번 시도해 보세요.",
	L"모든 서버군에서 캐릭터를 찾지 못했습니다.",
...
static wchar_t* szErrorStrF[] = {
	...
	L"UNKNOWN",
	L"I'm taken.",
	L"Two-timing is not allowed!",
	L"You can request to be a couple in villages and fields only.",
	L"The user is not logged in.",
	L"The couple ring does not exist in your inventory.",
	L"Same sex characters cannot be couples.",
	L"The character name does not exist in the server group.",
	L"The information of the target user for the couple request is invalid.",
	L"This is not a normal character name.",
	L"Unknown Error.",
	L"The user does not exist.",
	L"The player has dropped the ring by mistake! Tell the player to go find it!",
	L"The other character has accepted, but the ring is not in the inventory! Please check the inventory!",
	L"Failed to delete the Couple System item.",
	L"The requested couple information is invalid.",
	L"You are a single. You do not have anyone, so there is no information to give you.",
	L"The selected option value is invalid.",
	L"The inventory does not contain the wedding ring.",
	L"The necessary item for the selected options does not exist in the inventory.",
	L"You can get married after 72 hours after becoming a couple.",
	L"You have to be a couple in order to get married.",
	L"무료 1차 전직 이벤트를 진행할 수 있는 상태가 아닙니다.",
	L"The Items required for the marriage do not exist in the inventory.",
	L"You have failed to use the item for the marriage.",
	L"You have more guests than the actual wedding invitations.",
	L"이벤트 기간이 종료되어 전직이 불가능합니다.",
	...
	L"You have requested item information that does not exist.",
	L"The item is not for a wedding.",
	L"There is no item information for the wedding.",
	L"There is no information on a wedding hall reservation.",
	L"User nickname that requested a marriage cannot be found.",
	L"Not in the appropriate status to be a couple or get married.",
	L"You cannot summon from a dungeon.",
	L"The cash type is not supported.",
	L"You are not ready to summon.",
	L"You can only summon in the same channel.",
	L"Leave field to summon your couple.",
	L"The item information does not exist.",
	L"This is not a place to enter the wedding hall.",
	L"This is not an item to use to enter the wedding hall.",
	L"Leave field to enter the wedding hall.",
	L"The wedding ceremony is over or does not exist.",
	L"You are not a couple.",
	L"You have failed to enter the wedding hall.",
	L"You cannot summon to this field.",
	L"You cannot break-up in this place.",
	L"You cannot pay alimony.",
	L"You are not a bride or a groom.",
	L"The bride and groom have to be in the same room.",
	L"Bring your love request~Chu~",
	L"The Love Phoru was sent by mail.",
	L"The Love Phoru was sent by mail.",
	L"Bring your love request~Chu~",
	L"Phoru's love letter requires 10,000 ED to send.",
	L"Phoru's love letter was not sent.",
	L"You are not in a couple.",
	L"Your Couple's Nickname Change Ticket information is invalid.",
	L"You cannot delete when you are a couple.",
	L"An Error occurred while refreshing VIP ",
	L"You cannot select this option.",
	L"The compounded part is not the same.",
	L"You are not married.",
	L"The couple has failed to enter the field.",
	...
	L"[BR] 레벨업 인증 에러",
	L"Elsword and Elesis are siblings, so you cannot request to couple.",
	L"현재 레벨에서는 사용할 수 없습니다.",
	L"선택한 유닛 클래스 정보가 이상합니다.",
	L"",
	L"",
	...
	L"The Virtual Marriage Application does not exist in the inventory.",
	L"The Virtual Marriage Application does not exist in the inventory.",
	L"The virtual marriage partner does not exist.",
	L"Failed to delete the Virtual Marriage Application.",
	L"Failed to delete the Virtual Marriage Application.",
	...
	L"You cannot create characters because you have exceeded the limit.",
	L"The player has accepted, but the Virtual Marriage Application is not in your inventory! Please check your inventory!",
	L"The player lost the Virtual Marriage Application! Please tell him/her to go find it!",
	L"You need a Virtual Couple partner to start.",
	L"",
	L"",
	L"",
	L"",
	...
	L"",
	L"",
	L"You cannot delete a previously created character.",
	L"",
	L"",
	L"",
	L"",
	...
	L"You can't play with a user from a different level group.",
	L"Removed from the party due to illegal user check system.",
	L"Removed from the party due to reforming of a party.",
	L"Removed from the party due to invalid party member search.",
	L"Removed from the party due to leaving before entering the Gate of Darkness.",
	L"Your account has been blocked(LE3). Please visit our website and contact Customer Support.",
	L"Login is denied(LE2). Please visit our website and contact Customer Support.",
	L"Your account has been blocked(LE4). Please visit our website and contact Customer Support.",
	L"Login is denied(LE1). Please visit our website and contact Customer Support.",
	L"",
	L"",
	L"",
	L"",
