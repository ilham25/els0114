...
public:
	...
	DWORD GetLastIocpFailedError() { return m_dwLastIocpFailedError; }
	void SetLastIocpFailedError( DWORD dwLastIocpFailedError ) { m_dwLastIocpFailedError = dwLastIocpFailedError; }
	//}}
