...
Server:SetHackShieldHSBFilePath( "C:\\Servers\\JP_INTERNAL\\GameServer\\HackShield\\X2.hsb" )
...
--]]
SimLayer:AddCommonFlag( CF_NONE )
...
--]]
--SimLayer:SetAuthFlag( AF_NHN_JAPAN )
...
DBLayer:AddDB( DC_ACCOUNT,		'Config\\JP\\Account.dsn',				1, false )
DBLayer:AddDB( DC_GAME,			'Config\\JP\\Game01_SOLES.dsn',			3, false )
DBLayer:AddDB( DC_LOG,			'Config\\JP\\Log_SOLES.dsn',			3, false )
DBLayer:AddDB( DC_KOG_BILLING,	'Config\\JP\\Billing_INTERNAL.dsn',		3, false )
DBLayer:AddDB( DC_JP_RELAY_DB,	'Config\\JP\\RelayDB_INTERNAL.dsn',		3, false )
DBLayer:AddDB( DC_SCRIPT,		'Config\\JP\\Script.dsn',				1, false )
