...
--Server:SetHackShieldHSBFilePath( "E:\\ElswordPatch\\ServerPatch_KR\\GameServer\\HackShield\\X2.hsb" )
...
--then
PayletterBillingManager:InitPayletterBillingInfo( '172.18.76.2', 30010, 99 )
