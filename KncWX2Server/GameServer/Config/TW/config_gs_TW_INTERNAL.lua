...
Server:SetHackShieldHSBFilePath( "C:\\Servers\\TW_INTERNAL\\GameServer\\HackShield\\X2.hsb" )
...
-- Script File Path --
SimLayer:AddPath( "D:\\ProjectX2_SVN\\source\\JP_TW_EU_CN_US\\Trunk\\KncWX2Server\\ServerResource\\TW" ) -- server script
SimLayer:AddPath( "D:\\ProjectX2_SVN\\resource\\ES_INT\\TW\\Trunk\\dat\\Script" ) -- client script
...
DBLayer:AddDB( DC_ACCOUNT,	'Config\\TW\\Account_INTERNAL.dsn',			1, false )

if Server:GetServerGroupID() == 0 then
	DBLayer:AddDB( DC_GAME,		'Config\\TW\\Game01_SOLES_INTERNAL.dsn',		3, false )
	DBLayer:AddDB( DC_LOG,		'Config\\TW\\Log_SOLES_INTERNAL.dsn',		3, false )
elseif Server:GetServerGroupID() == 1 then
	DBLayer:AddDB( DC_GAME,		'Config\\TW\\Game02_GAIA_INTERNAL.dsn',		3, false )
	DBLayer:AddDB( DC_LOG,		'Config\\TW\\Log_GAIA_INTERNAL.dsn',		3, false )
else
	DBLayer:AddDB( DC_GAME,		'Config\\TW\\Game01_SOLES_INTERNAL.dsn',		3, false )
	DBLayer:AddDB( DC_LOG,		'Config\\TW\\Log_SOLES_INTERNAL.dsn',		3, false )
end

DBLayer:AddDB( DC_KOG_BILLING,	'Config\\TW\\Billing_INTERNAL.dsn',		3, false )
