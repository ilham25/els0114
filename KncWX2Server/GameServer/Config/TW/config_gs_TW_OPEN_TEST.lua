...
DBLayer:AddDB( DC_KOG_BILLING,		'Billing_TEST.dsn',		3, false )
DBLayer:AddDB( DC_PUBLISHER_BILLING,	'Billing_GAMANIA_TEST.dsn',	3, false )
...
then
	...
	GASHBillingTCPManager:InitGASHBillingTCPAddress( '192.168.211.199', 5412, 5413 )
