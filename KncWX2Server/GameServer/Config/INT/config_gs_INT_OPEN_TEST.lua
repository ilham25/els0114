...
Server:SetHackShieldHSBFilePath( "C:\\ElswordPatch\\ServerPatch_KR_BATTLE_FIELD\\GameServer\\HackShield\\X2.hsb" )
...
--]]
--SimLayer:SetBillingFlag( BF_NEXON_KOREA_TEST ) -- 배틀필드서버는 빌링을 세팅해두지 않습니다.
...
DBLayer:AddDB( DC_ACCOUNT,	'DRIVER=SQL Server;Network=DBMSSOCN;DATABASE=Account;WSID=ES_GS_OPEN_TEST;SERVER=211.39.155.71,6424',			10, true )

if Server:GetServerGroupID() == 0 then
	DBLayer:AddDB( DC_GAME,		'DRIVER=SQL Server;Network=DBMSSOCN;DATABASE=Game01;WSID=ES_GS_OPEN_TEST;SERVER=211.39.155.71,6424',			15, true )
	DBLayer:AddDB( DC_LOG,		'DRIVER=SQL Server;Network=DBMSSOCN;DATABASE=Statistics;WSID=ES_GS_OPEN_TEST;SERVER=211.39.155.71,6424',		10, true )
else
	DBLayer:AddDB( DC_GAME,		'DRIVER=SQL Server;Network=DBMSSOCN;DATABASE=Game02;WSID=ES_GS_OPEN_TEST;SERVER=211.39.155.71,6424',			15, true )
	DBLayer:AddDB( DC_LOG,		'DRIVER=SQL Server;Network=DBMSSOCN;DATABASE=Statistics02;WSID=ES_GS_OPEN_TEST;SERVER=211.39.155.71,6424',	10, true )
end
