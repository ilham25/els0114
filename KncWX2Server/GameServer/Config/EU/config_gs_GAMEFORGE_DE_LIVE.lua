...
DBLayer:AddDB( DC_ACCOUNT,	'Account_GAMEFORGE_DE_LIVE.dsn',				10, false )
DBLayer:AddDB( DC_GAME,		'Game01_GAMEFORGE_DE_LIVE.dsn',				15, false )
DBLayer:AddDB( DC_LOG,		'Log_GAMEFORGE_DE_LIVE.dsn',						10, false )	
DBLayer:AddDB( DC_KOG_BILLING,		'Billing_GAMEFORGE_DE_LIVE.dsn',		10, false )
DBLayer:AddDB( DC_CHAT_LOG,   'ChatLog_GAMEFORGE_DE_LIVE.dsn',   5, false )


----------     빌링 설정     ----------

if SimLayer:GetNationFlag() == NF_DE
then
  ...
  GFBillingManager:AddWebServiceAddress( 'http://de.soapinterface.elsword.de/elsword' )
