...
DBLayer:AddDB( DC_ACCOUNT,	'Account_GAMEFORGE_ES_LIVE.dsn',				10, false )
DBLayer:AddDB( DC_GAME,		'Game01_GAMEFORGE_ES_LIVE.dsn',				15, false )
DBLayer:AddDB( DC_LOG,		'Log_GAMEFORGE_ES_LIVE.dsn',						10, false )	
DBLayer:AddDB( DC_KOG_BILLING,		'Billing_GAMEFORGE_ES_LIVE.dsn',		10, false )
DBLayer:AddDB( DC_CHAT_LOG,   'ChatLog_GAMEFORGE_ES_LIVE.dsn',   5, false )
...
then
  ...
  GFBillingManager:AddWebServiceAddress( 'http://es.soapinterface.elsword.de/elsword' )
