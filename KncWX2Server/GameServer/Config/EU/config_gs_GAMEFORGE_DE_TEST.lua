...
DBLayer:AddDB( DC_GAME,		'Game01_GAMEFORGE_DE_TEST.dsn',				3, false )
DBLayer:AddDB( DC_LOG,		'Log_GAMEFORGE_DE_TEST.dsn',						3, false )	
DBLayer:AddDB( DC_KOG_BILLING,	'Billing_GAMEFORGE_DE_TEST.dsn',		3, false )
DBLayer:AddDB( DC_CHAT_LOG,   'ChatLog_GAMEFORGE_DE_TEST.dsn',    3, false )
