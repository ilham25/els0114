...
DBLayer:AddDB( DC_ACCOUNT,	'Account_GAMEFORGE_FR_TEST.dsn',				1, false )
DBLayer:AddDB( DC_GAME,		'Game01_GAMEFORGE_FR_TEST.dsn',				3, false )
DBLayer:AddDB( DC_LOG,		'Log_GAMEFORGE_FR_TEST.dsn',						3, false )	
DBLayer:AddDB( DC_KOG_BILLING,	'Billing_GAMEFORGE_FR_TEST.dsn',		3, false )
DBLayer:AddDB( DC_CHAT_LOG,   'ChatLog_GAMEFORGE_FR_TEST.dsn',    3, false )


----------     빌링 설정     ----------

if SimLayer:GetNationFlag() == NF_FR
then
  ...
  GFBillingManager:AddWebServiceAddress( 'http://dev.fr.soapinterface.elsword.de:9980/elsword' )  
