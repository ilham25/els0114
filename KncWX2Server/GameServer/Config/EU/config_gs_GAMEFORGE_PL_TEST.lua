...
DBLayer:AddDB( DC_ACCOUNT,	'Account_GAMEFORGE_PL_TEST.dsn',				1, false )
DBLayer:AddDB( DC_GAME,		'Game01_GAMEFORGE_PL_TEST.dsn',				3, false )
DBLayer:AddDB( DC_LOG,		'Log_GAMEFORGE_PL_TEST.dsn',						3, false )	
DBLayer:AddDB( DC_KOG_BILLING,	'Billing_GAMEFORGE_PL_TEST.dsn',		3, false )
DBLayer:AddDB( DC_CHAT_LOG,   'ChatLog_GAMEFORGE_PL_TEST.dsn',    3, false )
...
then
  ...
  GFBillingManager:AddWebServiceAddress( 'http://dev.pl.soapinterface.elsword.de:9980/elsword' )  
