...
if Server:GetServerGroupID() == 0 then
	DBLayer:AddDB( DC_GAME,		'GAME01_INTERNAL.dsn',		3, false )
...
--PayletterBillingManager:InitPayletterBillingInfo( '203.238.156.169', 36101, 99 )
--PayletterBillingManager:SetNumThread( 1 )
