...
if Server:GetServerGroupID() == 0 then
	DBLayer:AddDB( DC_GAME,		'GAME01_SERVICE.dsn',		15, false )
elseif Server:GetServerGroupID() == 1 then
	...
	DBLayer:AddDB( DC_LOG,		'LOG_SERVICE.dsn',		10, false )

DBLayer:AddDB( DC_KOG_BILLING,		'BILLING_SERVICE.dsn',		10, false )
...
PayletterBillingManager:InitPayletterBillingInfo( '10.50.0.2', 36101, 99 )
