...
-- AddDB( DB 종류, file dsn, thread 개수, DBConnectionString여부 )
	...
	DBLayer:AddDB( DC_ACCOUNT,	'ACCOUNT_OPEN_TEST.dsn',			1, false )

if Server:GetServerGroupID() == 0 then
	DBLayer:AddDB( DC_GAME,		'GAME01_OPEN_TEST.dsn',		3, false )
...
DBLayer:AddDB( DC_KOG_BILLING,		'BILLING_OPEN_TEST.dsn',		3, false )
...
PayletterBillingManager:InitPayletterBillingInfo( '10.10.54.18', 36101, 99 )
