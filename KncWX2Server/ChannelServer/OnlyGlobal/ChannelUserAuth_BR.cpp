...
#include "../Common/OnlyGlobal/AuthAndBilling/BR/LevelUpAuthManager.h"	// BR

void KChannelUser::RequestPublisherLogin(const KECH_VERIFY_ACCOUNT_REQ& kPacket_)
{
	START_LOG( clog, L"브라질 LEVEL UP 인증 요청." )
		<< BUILD_LOG( GetUID() )
	...
	SiKLevelUpAuthManager()->QueueingEvent( spEvent );
