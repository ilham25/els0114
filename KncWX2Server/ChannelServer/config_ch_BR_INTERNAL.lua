...
Server:AddScriptParsingErrReportMail( 'hohocmc@kog.co.kr' ) -- 최민철
Server:AddScriptParsingErrReportMail( 'wonjin@kog.co.kr' ) -- 김원진
Server:AddScriptParsingErrReportMail( 'israfelz@kog.co.kr' ) -- 안경민
...
DBLayer:AddDB( DC_ACCOUNT,	'ACCOUNT_INTERNAL.dsn',		3, false )
