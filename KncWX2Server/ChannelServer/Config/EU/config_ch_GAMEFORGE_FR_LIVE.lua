...
DBLayer:AddDB( DC_ACCOUNT,	'Account_GAMEFORGE_FR_LIVE.dsn',	15, false )
DBLayer:AddDB( DC_LOG, 'Log_GAMEFORGE_FR_LIVE.dsn', 5, false )
...
then
  GFAuthManager:AddWebServiceAddress( 'http://fr.soapinterface.elsword.de/elsword' )  
  GFAuthManager:AddWebMethod( GFO_AUTH, 'urn:ElswordAction' ) 
  GFAuthManager:Init( 10 )
end
