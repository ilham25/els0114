...
DBLayer:AddDB( DC_ACCOUNT,	'Account_GAMEFORGE_PL_LIVE.dsn',	15, false )
DBLayer:AddDB( DC_LOG, 'Log_GAMEFORGE_PL_LIVE.dsn', 5, false )
...
then
  GFAuthManager:AddWebServiceAddress( 'http://pl.soapinterface.elsword.de/elsword' )  
