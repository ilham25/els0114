...
elseif Server:GetServerGroupID() == 2 then
	DBLayer:AddDB( DC_ACCOUNT,	'Account_CN_ZR02_SERVICE.dsn',			5, false )
	DBLayer:AddDB( DC_LOG, 			'Log_CN_ZR02_SERVICE.dsn', 				5, false )
elseif Server:GetServerGroupID() == 3 then
	DBLayer:AddDB( DC_ACCOUNT,	'Account_CN_ZR03_SERVICE.dsn',			5, false )
...
elseif Server:GetServerGroupID() == 5 then
	DBLayer:AddDB( DC_ACCOUNT,	'Account_CN_WH02_SERVICE.dsn',					5, false )
...
elseif Server:GetServerGroupID() == 102 then
	DBLayer:AddDB( DC_ACCOUNT,	'Account_CN_TJ02_SERVICE.dsn',			5, false )
