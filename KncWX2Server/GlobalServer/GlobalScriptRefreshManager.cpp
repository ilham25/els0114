...
ImplPfID( KGlobalScriptRefreshManager, PI_NULL );

ImplementSingleton( KGlobalScriptRefreshManager );

KGlobalScriptRefreshManager::KGlobalScriptRefreshManager() :
...
void KGlobalScriptRefreshManager::Init()
{
...
KThread* KGlobalScriptRefreshManager::CreateThread()
{
	return new KGlobalScriptRefreshThread;
}
