...
class KGlobalScriptRefreshManager : public KThreadManager
{
	DeclareSingleton( KGlobalScriptRefreshManager );
	DeclPfID;

public:
	KGlobalScriptRefreshManager();
	virtual ~KGlobalScriptRefreshManager();
...
DefSingletonInline( KGlobalScriptRefreshManager );
