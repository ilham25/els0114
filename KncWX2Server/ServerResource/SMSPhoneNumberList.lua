...
g_SMSPhoneNumberManager:AddTeamPhoneNumber( PNLT_ELSWORD_DEV_TEAM, '010-7444-4661' )  -- 우상혁
g_SMSPhoneNumberManager:AddTeamPhoneNumber( PNLT_ELSWORD_DEV_TEAM, '010-3323-7753' )  -- 박세훈
g_SMSPhoneNumberManager:AddTeamPhoneNumber( PNLT_ELSWORD_DEV_TEAM, '010-5650-1400' )	  -- 이재왕
...
g_SMSPhoneNumberManager:AddTeamPhoneNumber( PNLT_NEXON,	'010-5046-0219' )	-- 염홍원

-- 엘소드 개발팀 서버 담당자 전화번호 리스트
g_SMSPhoneNumberManager:AddTeamPhoneNumber( PNLT_ELSWORD_DEV_TEAM_SERVER, '010-7444-4661' )  -- 우상혁
...
g_SMSPhoneNumberManager:AddFuntionalPhoneNumber( FS_SERVER_STATE,	'010-2531-1411' )	-- 박성준
g_SMSPhoneNumberManager:AddFuntionalPhoneNumber( FS_SERVER_STATE,	'010-2748-7143' )	-- 김기훈
