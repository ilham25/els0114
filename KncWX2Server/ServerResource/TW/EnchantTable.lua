...
EnchantItemManager:SetRareWeaponEnchantStone( 152000121 )
EnchantItemManager:SetArmorEnchantStone( 109965 )
EnchantItemManager:SetRareArmorEnchantStone( 152000122 )
...
EnchantItemManager:SetEnchantProbability_Event(  7, { Up1 =  10, NoChange =  20, Down1 = 40, DownTo0 = 20, Break = 10   } )
EnchantItemManager:SetEnchantProbability_Event(  8, { Up1 =   5, NoChange =  15, Down1 = 30, DownTo0 = 40, Break = 10   } )
EnchantItemManager:SetEnchantProbability_Event(  9, { Up1 =   2, NoChange =  10, Down1 = 28, DownTo0 = 40, Break = 20   } )
EnchantItemManager:SetEnchantProbability_Event( 10, { Up1 = 0.7, NoChange =   7, Down1 = 27, DownTo0 = 40, Break = 25.3   } )
EnchantItemManager:SetEnchantProbability_Event( 11, { Up1 = 0.6, NoChange =   7, Down1 = 27, DownTo0 = 30, Break = 35.4   } )
EnchantItemManager:SetEnchantProbability_Event( 12, { Up1 =   0, NoChange =   8, Down1 = 27, DownTo0 = 40, Break = 25   } )
EnchantItemManager:SetEnchantProbability_Event( 13, { Up1 =   0, NoChange =   4, Down1 = 27, DownTo0 = 40, Break = 29   } )
EnchantItemManager:SetEnchantProbability_Event( 14, { Up1 =   1, NoChange =   7, Down1 = 27, DownTo0 = 40, Break = 25   } )
EnchantItemManager:SetEnchantProbability_Event( 15, { Up1 = 0.5, NoChange = 5.5, Down1 = 27, DownTo0 = 40, Break = 27   } )
EnchantItemManager:SetEnchantProbability_Event( 16, { Up1 = 0.5, NoChange = 5.5, Down1 = 27, DownTo0 = 40, Break = 27   } )
EnchantItemManager:SetEnchantProbability_Event( 17, { Up1 = 0.3, NoChange =   5, Down1 = 27, DownTo0 = 40, Break = 27.7 } )
EnchantItemManager:SetEnchantProbability_Event( 18, { Up1 = 0.3, NoChange =   5, Down1 = 27, DownTo0 = 40, Break = 27.7 } )
EnchantItemManager:SetEnchantProbability_Event( 19, { Up1 = 0.1, NoChange =   4, Down1 = 27, DownTo0 = 40, Break = 28.9 } )
EnchantItemManager:SetEnchantProbability_Event( 20, { Up1 =   0, NoChange =   4, Down1 = 27, DownTo0 = 40, Break = 29   } )
...
EnchantItemManager:SetEnchantPlusProbability(  2, { Up1 = 100 , NoChange =   0 , Down1 =  0, DownTo0 =  0, Break =  0   } )
EnchantItemManager:SetEnchantPlusProbability(  3, { Up1 =  88 , NoChange =  12 , Down1 =  0, DownTo0 =  0, Break =  0   } )
EnchantItemManager:SetEnchantPlusProbability(  4, { Up1 =  66 , NoChange =  34 , Down1 =  0, DownTo0 =  0, Break =  0   } )
EnchantItemManager:SetEnchantPlusProbability(  5, { Up1 =  22 , NoChange =  48 , Down1 = 30, DownTo0 =  0, Break =  0   } )
EnchantItemManager:SetEnchantPlusProbability(  6, { Up1 =  11 , NoChange =  39 , Down1 = 50, DownTo0 =  0, Break =  0   } )
EnchantItemManager:SetEnchantPlusProbability(  7, { Up1 =  11 , NoChange =  19 , Down1 = 40, DownTo0 = 20, Break = 10   } )
EnchantItemManager:SetEnchantPlusProbability(  8, { Up1 = 5.5 , NoChange = 14.5, Down1 = 30, DownTo0 = 40, Break = 10   } )
EnchantItemManager:SetEnchantPlusProbability(  9, { Up1 = 2.2 , NoChange =  9.8, Down1 = 28, DownTo0 = 40, Break = 20   } )
EnchantItemManager:SetEnchantPlusProbability( 10, { Up1 = 0.77, NoChange = 6.93, Down1 = 27, DownTo0 = 40, Break = 25.3   } )
EnchantItemManager:SetEnchantPlusProbability( 11, { Up1 = 0.66, NoChange = 6.94, Down1 = 27, DownTo0 = 30, Break = 35.4   } )
EnchantItemManager:SetEnchantPlusProbability( 12, { Up1 =   0 , NoChange =   8 , Down1 = 27, DownTo0 = 40, Break = 25   } )
EnchantItemManager:SetEnchantPlusProbability( 13, { Up1 =   0 , NoChange =   4 , Down1 = 27, DownTo0 = 40, Break = 29   } )
EnchantItemManager:SetEnchantPlusProbability( 14, { Up1 =  1.1, NoChange =  6.9, Down1 = 27, DownTo0 = 40, Break = 25   } )
EnchantItemManager:SetEnchantPlusProbability( 15, { Up1 = 0.55, NoChange = 5.45, Down1 = 27, DownTo0 = 40, Break = 27   } )
EnchantItemManager:SetEnchantPlusProbability( 16, { Up1 = 0.55, NoChange = 5.45, Down1 = 27, DownTo0 = 40, Break = 27   } )
EnchantItemManager:SetEnchantPlusProbability( 17, { Up1 = 0.33, NoChange = 4.97, Down1 = 27, DownTo0 = 40, Break = 27.7 } )
EnchantItemManager:SetEnchantPlusProbability( 18, { Up1 = 0.33, NoChange = 4.97, Down1 = 27, DownTo0 = 40, Break = 27.7 } )
EnchantItemManager:SetEnchantPlusProbability( 19, { Up1 = 0.11, NoChange = 3.99, Down1 = 27, DownTo0 = 40, Break = 28.9 } )
EnchantItemManager:SetEnchantPlusProbability( 20, { Up1 =   0 , NoChange =   4 , Down1 = 27, DownTo0 = 40, Break = 29   } )
