...
--	엘더_01_월리기념교													
g_pBattleFieldManager:BattleFieldEventBossDropInfo	--2013.03.06													
{														
	BattleFieldID = 40001,												-- #NAME?	
	MonsterID = 4038,													-- #NAME?
	SetEventBossCommonBonusItemID = 0,													
	SetEventBossCommonBonusItemCount = 0,													
	SetEventBossBonusItemID	= 141000884,												
	SetEventBossBonusItemIDCount_High	= 2,												
	SetEventBossBonusItemIDCount_Low	= 1,												
}														
														
--	엘더_02_쌍둥이 감시탑													
g_pBattleFieldManager:BattleFieldEventBossDropInfo	--2013.03.06													
{														
	BattleFieldID = 40002,												-- #NAME?	
	MonsterID = 4038,													-- #NAME?
	SetEventBossCommonBonusItemID = 0,													
	SetEventBossCommonBonusItemCount = 0,													
	SetEventBossBonusItemID	= 141000884,												
