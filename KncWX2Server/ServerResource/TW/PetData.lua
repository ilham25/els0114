...
g_pPetManager:AddPetCreateItemInfo( 75000724, PET_UNIT_ID["PUI_TREE_KNIGHT_WINTER"], -1 )	-- 트리 나이트 겨울
g_pPetManager:AddPetCreateItemInfo( 75000725, PET_UNIT_ID["PUI_TREE_KNIGHT_WINTER_F"], -1 )			-- 트리 나이트 겨울 (완전체)
