...
-- 추가 김현철 11/21
DropTable:AddNotifyDropItemInfo( 135463 ) -- 시간의 관문 수호자 무기 교환권
...
--2013 할로윈, 해피 할로윈 퍼핏 대량 드랍
--DropTable:AddManyEDDropNpc( NPC_UNIT_ID["NUI_HAPPY_HALLOWEEN_DROP_DUMMY1"], 50, 5 )	--일반 라운드 보상

--DropTable:AddManyEDDropNpc( NPC_UNIT_ID["NUI_HAPPY_HALLOWEEN_DROP_DUMMY2"], 500, 5 ) --스페셜 라운드 보상
--DropTable:AddManyEDDropNpc( NPC_UNIT_ID["NUI_HAPPY_HALLOWEEN_DROP_DUMMY3"], 500, 5 ) --10 라운드 클리어 보상
