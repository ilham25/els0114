...
--JP 4주년 이벤트. 7일권 소환석 추가
g_pRidingPetManager:AddRidingPetCreateItemInfo( 100000255, RIDING_PET_UNIT_ID["RPUI_SCORPION_TYPE_R"],	7	)		-- 소환석 : 퐁고 스콜피온 TYPE-R (7일권)
g_pRidingPetManager:AddRidingPetCreateItemInfo( 100000256, RIDING_PET_UNIT_ID["RPUI_ICE_HAMELING"],	7	)		-- 소환석 : 아이스 하멜링 (7일권)
g_pRidingPetManager:AddRidingPetCreateItemInfo( 100000257, RIDING_PET_UNIT_ID["RPUI_DARK_HAMELING"],	7	)		-- 소환석 : 다크 하멜링 (7일권)
g_pRidingPetManager:AddRidingPetCreateItemInfo( 100000258, RIDING_PET_UNIT_ID["RPUI_RED_HAMELING"],	7	)		-- 소환석 : 파이어 하멜링 (7일권)
g_pRidingPetManager:AddRidingPetCreateItemInfo( 100000259, RIDING_PET_UNIT_ID["RPUI_OBERON_CUSTOM_650"],	7	)		-- 소환석 : 이브 커스텀-오베론650 (7일권)
g_pRidingPetManager:AddRidingPetCreateItemInfo( 100000260, RIDING_PET_UNIT_ID["RPUI_OBERON_CUSTOM_650_BLACK_SKULL"],	7	)		-- 소환석 : 이브 커스텀-블랙 스컬 (7일권)
g_pRidingPetManager:AddRidingPetCreateItemInfo( 100000261, RIDING_PET_UNIT_ID["RPUI_OBERON_CUSTOM_650_ANGEL_HEART"],	7	)		-- 소환석 : 이브 커스텀-엔젤 하트 (7일권)