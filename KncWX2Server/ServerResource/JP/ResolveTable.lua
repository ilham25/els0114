...
-- 엘의 조각(불명)
g_pResolveItemManager:AddResolveData( ITEM_GRADE["IG_UNIQUE"], 130047, { fSuccRate = 20, iRandomCnt = 1, iResultCnt = 1, iBeginLv = 60, iEndLv =  100 } )
g_pResolveItemManager:AddResolveData( ITEM_GRADE["IG_ELITE"],  130047, { fSuccRate = 10, iRandomCnt = 1, iResultCnt = 1, iBeginLv = 60, iEndLv =  100 } )
g_pResolveItemManager:AddResolveData( ITEM_GRADE["IG_RARE"],   130047, { fSuccRate = 3, iRandomCnt = 1, iResultCnt = 1, iBeginLv = 60, iEndLv =  100 } )

-- #ifdef SERV_MULTI_RESOLVE 임규수 일본 추가 아바타 분해
--[[
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	72510	, { fSuccRate =	3.15	} ) --	추가 데미지의 마법석
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	72520	, { fSuccRate =	3.78	} ) --	데미지 감소의 마법석 
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	132197	, { fSuccRate =	6.93	} ) --	각성 지속의 마법석
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	132198	, { fSuccRate =	7.56	} ) --	체력의 마법석
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	132199	, { fSuccRate =	8.19	} ) --	각성 충전의 마법석
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	132200	, { fSuccRate =	3.15	} ) --	속도의 마법석
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	132201	, { fSuccRate =	3.78	} ) --	크리티컬의 마법석
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	132202	, { fSuccRate =	8.19	} ) --	이동 속도의 마법석
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	132203	, { fSuccRate =	8.82	} ) --	명중의 마법석
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	132204	, { fSuccRate =	4.41	} ) --	회피의 마법석
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	132205	, { fSuccRate =	5.04	} ) --	점프 속도의 마법석 
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	111701	, { fSuccRate =	0.6	} ) --	파괴의 마법석
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	111702	, { fSuccRate =	0.6	} ) --	폭발의 마법석
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	111703	, { fSuccRate =	0.6	} ) --	연소의 마법석
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	111704	, { fSuccRate =	0.6	} ) --	신속의 마법석
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	111705	, { fSuccRate =	0.6	} ) --	격노의 마법석
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	133365	, { fSuccRate =	1.6	} ) --	정제된 엘의 조각(블레이즈 마스터)
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	133366	, { fSuccRate =	1.6	} ) --	정제된 엘의 조각(프로즌 마스터)
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	133367	, { fSuccRate =	1.6	} ) --	정제된 엘의 조각(포이즌 마스터)
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	133368	, { fSuccRate =	1.6	} ) --	정제된 엘의 조각(마스터 피어싱)
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	133369	, { fSuccRate =	1.6	} ) --	정제된 엘의 조각(마스터 쇼크)
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	133370	, { fSuccRate =	1.6	} ) --	정제된 엘의 조각(마스터 스내치)
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	133371	, { fSuccRate =	1.6	} ) --	정제된 엘의 조각(블레이즈 피어싱)
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	133372	, { fSuccRate =	1.6	} ) --	정제된 엘의 조각(블레이즈 쇼크)
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	133373	, { fSuccRate =	1.6	} ) --	정제된 엘의 조각(블레이즈 스내치)
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	133374	, { fSuccRate =	1.6	} ) --	정제된 엘의 조각(프로즌 피어싱)
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	133375	, { fSuccRate =	1.6	} ) --	정제된 엘의 조각(프로즌 쇼크)
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	133376	, { fSuccRate =	1.6	} ) --	정제된 엘의 조각(프로즌 스내치)
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	133377	, { fSuccRate =	1.6	} ) --	정제된 엘의 조각(포이즌 피어싱)
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	133378	, { fSuccRate =	1.6	} ) --	정제된 엘의 조각(포이즌 쇼크)
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	133379	, { fSuccRate =	1.6	} ) --	정제된 엘의 조각(포이즌 스내치) 
g_pResolveItemManager:AddResolveDataAvatar( ITEM_GRADE["IG_UNIQUE"],	65000550	, { fSuccRate =	10	} ) --	합성제
--]]
