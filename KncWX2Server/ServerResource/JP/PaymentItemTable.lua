...
-- 아라 신 전직 전야 이벤트
--DropTable:AddPaymentDungeon( DUNGEON_KINDS["LEVEL_DUNGEON"],		{ iItemID = 85003832, fRate = 100, iQuestID = 85660, wstrBeginDate = '2014-01-06 10:00:00', wstrEndDate = '2014-01-14 23:59:00'  } )  
--DropTable:AddPaymentDungeon( DUNGEON_KINDS["LEVEL_DUNGEON"],		{ iItemID = 85003832, fRate = 100, iQuestID = 85660, wstrBeginDate = '2014-01-22 10:00:00', wstrEndDate = '2014-01-28 09:59:00'  } )  
...
--[[
-- 현자의 주문서
DropTable:AddPaymentDungeon( DUNGEON_KINDS["LEVEL_DUNGEON"],{ iItemID = 160267, fRate = 100, iMaxLv = 40, wstrBeginDate = '2013-07-20 14:00:00', wstrEndDate = '2013-07-20 15:00:00' } )
DropTable:AddPaymentDungeon( DUNGEON_KINDS["LEVEL_DUNGEON"],{ iItemID = 160267, fRate = 100, iMaxLv = 40, wstrBeginDate = '2013-07-21 14:00:00', wstrEndDate = '2013-07-21 15:00:00' } )
...
-- 현자의 마법석
DropTable:AddPaymentDungeon( DUNGEON_KINDS["LEVEL_DUNGEON"],{ iItemID = 135184, fRate = 100, iMinLv = 41, wstrBeginDate = '2013-07-20 14:00:00', wstrEndDate = '2013-07-20 15:00:00' } )
DropTable:AddPaymentDungeon( DUNGEON_KINDS["LEVEL_DUNGEON"],{ iItemID = 135184, fRate = 100, iMinLv = 41, wstrBeginDate = '2013-07-21 14:00:00', wstrEndDate = '2013-07-21 15:00:00' } )
