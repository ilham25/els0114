...
DBLayer:AddDB( DC_ACCOUNT,	'Account_CN_BETA.dsn',		3, false )
DBLayer:AddDB( DC_GAME,		'Game_CN_BETA.dsn',			3, false )
DBLayer:AddDB( DC_LOG, 		'Log_CN_BETA.dsn', 			3, false )
DBLayer:AddDB( DC_KOG_BILLING,	'Billing_CN_BETA.dsn',		3, false )
...
if Server:GetServerGroupID() == 0 then
	...
	GiantCouponManager:SetAddress( '222.73.243.200', 9967 )
