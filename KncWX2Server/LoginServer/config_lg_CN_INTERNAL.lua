...
-- Script File Path --
SimLayer:AddPath( "D:\\projectx2_svn\\source\\ES_INT\\Branches\\ES_CN\\KncWX2Server\\ServerResource" ) -- server script
...
DBLayer:AddDB( DC_ACCOUNT,	'Account_CN_INTERNAL.dsn',		3, false )
DBLayer:AddDB( DC_LOG,			'Log_CN_INTERNAL.dsn',			3, false )
DBLayer:AddDB( DC_KOG_BILLING,		'Billing_CN_INTERNAL.dsn',		3, false )


if Server:GetServerGroupID() == 0 then
	DBLayer:AddDB( DC_GAME,		'Game_CN_INTERNAL.dsn',		3, false )
elseif Server:GetServerGroupID() == 6 then
	DBLayer:AddDB( DC_GAME,		'Game_CN_INTERNAL_1.dsn',		3, false )
end
